---
title: "The [[39040799821588|ball object]]"
id: 71477384603897
types:
- objects
tags:
...
> 📂 [View source on GitHub](https://github.com/evangit2/hamsterball-re/blob/master/docs/objects/BALL_OBJECT.md)
...
1. [What Is the [[39040799821588|ball object]]?](#what-is-the-ball-object)
...
| **0x284** | **float** | **radius** | **35.0** | **Ball radius (ctor2=27.0, overridden to 35.0; shrunk to 13.0 on [[64833895235269|odd race]] shrink)** |
...
| 0x2E9 | uint8 | impact_shatter | 0 | ⚠ **NOT on_ramp/ground flag!** Sticky limit/trajectory flag (E:LIMIT + type-5 collision). Never cleared within Ball_Update. See [[22639509422765|docs/agent-knowledge]]/ball-ground-detection.md |
...
| 0xC4C | uint8 | is_shrunk | 0 | [[64833895235269|odd race]] shrunk state (E:SHRINK=1, E:GROW=0) |
...
| 0x4CF36C | 0.75 | Force multiplier when is_shrunk ([[64833895235269|odd race]]) |
...
|-------|--------|-----------------|--------------|
| radius | 0x284 | 35.0 | Collision + visual size. Shrunk to 13.0 on [[64833895235269|odd race]] shrink. |
...
| `is_shrunk` flag (ball+0xC4C) | `DAT_004CF36C` | `0.75` | Shrunk ([[64833895235269|odd race]]): 75% force |
...
| 0xC4C (is_shrunk) | Set by [[64833895235269|odd race]] E:SHRINK/E:GROW |
...
| 6 | Ball_Shrink | 0x402200 | On [[64833895235269|odd race]] | Prevent shrink, teleport instead |
...
| 0x402200 | Ball_Shrink | — | [[64833895235269|odd race]] shrink ball, reduce radius |
| 0x402270 | Ball_Grow | — | Exit [[64833895235269|odd race]] shrink state |
...
- [[62592078723303|Ball Physics Decompilation]]
