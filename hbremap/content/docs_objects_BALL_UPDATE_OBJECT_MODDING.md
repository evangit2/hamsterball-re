...
> 📂 [View source on GitHub](https://github.com/evangit2/hamsterball-re/blob/master/docs/objects/BALL_UPDATE_OBJECT_MODDING.md)
...
| 0x008 | `int32_t` | collision_result | ctor2 | Bitflags from [[53892486924051|collision system]] |
...
| 0x264 | `RumbleBoard` | rumble_timer1 | ctor2 | `ToggleTimer_Init` target (20 bytes) |
...
- [[71477384603897|The Ball Object]]
