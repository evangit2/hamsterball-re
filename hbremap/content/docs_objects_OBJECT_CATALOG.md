---
title: "Object Catalog for Modders"
id: 71059981178810
types:
- objects
tags:
...
> 📂 [View source on GitHub](https://github.com/evangit2/hamsterball-re/blob/master/docs/objects/OBJECT_CATALOG.md)
...
- **Key fields:**
  ...
  - `+0x2DC` lgp_x/y/z
  - `+0x768` cam_active
  - `+0xC4C` is_shrunk flag ([[64833895235269|odd race]] E:SHRINK/E:GROW)
...
- [[59402667484240|RE — Key Findings Summary]]
