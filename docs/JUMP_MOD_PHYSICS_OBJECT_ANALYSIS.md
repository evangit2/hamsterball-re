...
|| `+0x0C64` | `0x0C64` | `float` | `roll_friction` | `~0.56f` | `Ball_Update Phase 14` | **Overwritten every frame.** Not a speed control — controls rolling resistance. Lower = more slippery |
