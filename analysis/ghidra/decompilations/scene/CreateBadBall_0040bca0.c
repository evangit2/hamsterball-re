  ...
  *(undefined4 *)(iVar4 + 0x89c + iVar3 * 4) = 0;
  ...
  while( true ) {
    ...
    if (iVar4 == 0) {
      ...
      local_4 = 0xffffffff;
      (**(code **)(*piVar5 + 4))();
      // Ball position from MESHWORLD ref point (puVar7[1..3] = x,y,z)
      piVar5[0x59] = (int)((float)puVar7[1] + _DAT_004cf55c);  // ball+0x164 = POS_X
      piVar5[0x5a] = (int)((float)puVar7[2] + (float)piVar5[0xa1]);  // ball+0x168 = POS_Y (adjusted by ball size)
      fVar1 = (float)puVar7[3];
      *(undefined1 *)((int)piVar5 + 0x281) = 0;
      piVar5[0x5b] = (int)(fVar1 + _DAT_004cf55c);  // ball+0x16C = POS_Z
      if (piVar5 + 0x318 != puVar7 + 1) {
        piVar5[0x318] = puVar7[1];  // ball+0xC60 = spawn X
        piVar5[0x319] = puVar7[2];  // ball+0xC64 = spawn Y
        piVar5[0x31a] = puVar7[3];  // ball+0xC68 = spawn Z
      }
      Sprite_DrawColoredRect(auStack_24);
      local_4 = 1;
      AthenaString_Set(auStack_24,(char *)*puVar7);
      // Parse sub-tags: CHASE, HOME, SIZE, SPINDISTANCE
      puVar7 = MWParser_ReadTag((int)auStack_24);
      while (puVar7 != (undefined4 *)0x0) {
        iVar4 = __stricmp((char *)puVar7[1],"CHASE");
        if (iVar4 == 0) {
          lVar6 = _atol((char *)puVar7[2]);
          piVar5[0x31b] = (int)(float)lVar6;  // ball+0xC6C = chase target index
        }
        iVar4 = __stricmp((char *)puVar7[1],"HOME");
        if (iVar4 == 0) {
          lVar6 = _atol((char *)puVar7[2]);
          piVar5[0x31c] = (int)(float)lVar6;  // ball+0xC70 = home point index
        }
        iVar4 = __stricmp((char *)puVar7[1],"SIZE");
        if (iVar4 == 0) {
          lVar6 = _atol((char *)puVar7[2]);
          piVar5[0x62] = 0x40400000;  // ball+0x188 = 3.0f (render scale?)
          piVar5[0xa1] = (int)(float)lVar6;  // ball+0x284 = ball radius/size
          piVar5[0x9f] = 0;
          *(undefined1 *)(piVar5 + 0x313) = 1;  // ball+0xC4C = custom size flag
        }
        iVar4 = __stricmp((char *)puVar7[1],"SPINDISTANCE");
        if (iVar4 == 0) {
          lVar6 = _atol((char *)puVar7[2]);
          piVar5[799] = (int)(float)lVar6;  // ball+0xC7C = spin distance
        }
        (**(code **)*puVar7)(1);
        puVar7 = MWParser_ReadTag((int)auStack_24);
      }
      // Add ball to both ball list (Scene+0x29D4) and render list (Scene+0x2DEC)
