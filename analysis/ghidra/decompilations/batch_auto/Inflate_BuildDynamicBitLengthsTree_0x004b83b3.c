...
int __cdecl
Inflate_BuildDynamicBitLengthsTree(uint *param_1,int *param_2,int *param_3,int param_4,int param_5)

{
  ...
  if (puVar1 == (uint *)0x0) {
    ...
    iVar2 = Inflate_HuffmanBuild(param_1,0x13,0x13,0,0,param_3,param_4,&local_8,puVar1);
    if (iVar2 == -3) {
