  ...
  if ((*(uint *)param_2 & 8) == 0) {
    if ((*in_ECX & 1) == 0) {
      if (*(int *)(in_ECX + 0x18) == 0) {
        bVar1 = FID_conflict__ValidateRead(pvVar3,1);
        if ((CONCAT31(extraout_var_03,bVar1) != 0) &&
          ...
          pvVar3 = (void *)CRT_NLSStrLen((int *)(in_ECX + 8));
          _memmove(in_EDX,pvVar3,_Size);
          return;
        }
      }
      else {
...
LAB_004be608:
      iVar2 = CRT_NLSStrLen((int *)(in_ECX + 8));
      *in_EDX = iVar2;
      return;
    }
  }
