...
void __fastcall Ball_Render(int param_1)

{
  ...
  sVar2 = Ball_TestPlaneIntersection
  ...
  if ((char)sVar2 == '\0') {
    ...
    *(uint *)(param_1 + 0xc74) = *(byte *)(iVar3 + 0x234) + 1;
    ...
    if (*(char *)(param_1 + 0xc80) != '\0') {
      Graphics_SetViewportClip
                (*(void **)(*(int *)(param_1 + 0x10) + 0x174),*(undefined4 *)(param_1 + 0xc88),
                 *(undefined4 *)(param_1 + 0xc8c),*(undefined4 *)(param_1 + 0xc90),0x3f800000);
      Gfx_PackColorRGB(*(void **)(*(int *)(param_1 + 0x10) + 0x174));
    }
    ppuStack_94 = &PTR_Timer_dtor_004cf338;
    ...
    if (*(char *)(param_1 + 0x324) == '\0') {
      Sprite_RenderQuad(*(void **)(*(int *)(param_1 + 0x10) + 0x33c),*(float *)(param_1 + 0x164),
