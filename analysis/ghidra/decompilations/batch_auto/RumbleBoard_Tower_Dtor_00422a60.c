/*
 * Function: RumbleBoard_Tower_Dtor
 * Address: 0x00422a60
 * Signature: void __fastcall RumbleBoard_Tower_Dtor(undefined4 *param_1)
 *
 * Patterns: SEH frame, board. Calls: RumbleBoard_Tower_Dtor, Vec3List_Free, RumbleBoard_dtor. Offsets: 2, Lines: 32
 *
 * Decompiled from Hamsterball.exe (Athena Engine, PE32 i386)
 */

void __fastcall RumbleBoard_Tower_Dtor(undefined4 *param_1)

{
  ...
  *param_1 = &PTR_RumbleBoard_OddArena_DeletingDtor_004d1740;
  local_4 = 2;
