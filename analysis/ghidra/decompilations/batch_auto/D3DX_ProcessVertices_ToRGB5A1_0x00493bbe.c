...
void __thiscall D3DX_ProcessVertices_ToRGB5A1(void *this,uint param_1,uint param_2,int param_3)

{
  ...
  if (*(int *)((int)this + 0x1058) != 0) {
    ...
    do {
      ...
      iVar3 = iVar6 + 8;
      iVar6 = iVar6 + 0x10;
      *puVar7 = (ushort)(((int)ROUND(*pfVar1 * _DAT_004d5c24 + fVar4) << 5 |
                         (int)ROUND(*(float *)(iVar2 + param_3) * _DAT_004d5c24 + fVar4)) << 5) |
