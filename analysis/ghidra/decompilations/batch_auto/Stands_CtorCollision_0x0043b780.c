...

{
  ...
  puVar1 = (undefined4 *)((int)this + 0x10dc);
  local_4 = 0;
  *(undefined ***)this = &PTR_Button_DeletingDtor_004d5578;
  *(undefined4 *)((int)this + 0x10d0) = param_1;
  if (puVar1 != &param_2) {
    *puVar1 = param_2;
    *(undefined4 *)((int)this + 0x10e0) = param_3;
    *(undefined4 *)((int)this + 0x10e4) = param_4;
  }
  *(undefined4 *)((int)this + 0x10d8) = param_6;
