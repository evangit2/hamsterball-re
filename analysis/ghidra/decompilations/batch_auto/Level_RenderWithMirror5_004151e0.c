/*
 * Function: Level_RenderWithMirror5
 * Address: 0x004151e0
 * Signature: Level_RenderWithMirror5(...)
 *
 * Patterns: vtable dispatch, SEH frame, rendering, level. Calls: Level_RenderWithMirror5, Level_RenderDynamicObjects, Graphics_SetProjection, RenderContext_Init, Matrix4_Identity. Offsets: 8, Lines: 76
 *
...
void __thiscall Level_RenderWithMirror5(void *this,void *param_1)
