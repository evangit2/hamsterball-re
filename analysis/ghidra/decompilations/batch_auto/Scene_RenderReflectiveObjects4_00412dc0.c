/*
 * Function: Scene_RenderReflectiveObjects4
 * Address: 0x00412dc0
 * Signature: Scene_RenderReflectiveObjects4(...)
 *
 * Patterns: vtable dispatch, SEH frame, rendering, scene, level. Calls: Scene_RenderReflectiveObjects4, Level_RenderDynamicObjects, Graphics_SetProjection, RenderContext_Init, Matrix4_Identity. Offsets: 8, Lines: 76
 *
...
void __thiscall Scene_RenderReflectiveObjects4(void *this,void *param_1)

{
  ...
  *(float *)((int)param_1 + 0x794) = fVar2;
  ...
  iVar4 = (int)this + 0x439c;
  pfVar3 = (float *)((int)this + 0x53fc);
  param_1 = (void *)0x4;
  do {
