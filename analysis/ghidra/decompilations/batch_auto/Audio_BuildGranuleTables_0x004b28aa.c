...
void __cdecl Audio_BuildGranuleTables(int *param_1)

{
  ...
  if (0 < param_1[0x48]) {
    ...
    do {
      ...
      Huffman_BuildTable((int)piVar4,piVar4[iVar2 + 0x28],(int *)(iVar1 + 0x34 + iVar2 * 4));
      Huffman_BuildTable((int)piVar4,piVar4[iVar3 + 0x2c],(int *)(iVar1 + 0x44 + iVar3 * 4));
      *local_8 = 0;
      param_1 = param_1 + 1;
      local_8 = local_8 + 1;
      local_c = local_c + 1;
