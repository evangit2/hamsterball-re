...

{
  ...
  if (local_8 == 0) {
    if ((local_58 == 0) && ((local_5c & 0x200) == 0)) {
      D3D8_DebugSetMute(1);
      iVar5 = (**(code **)(*param_2 + 0x1c))(param_2,&DAT_004db25c,&local_18);
      if (iVar5 < 0) {
        local_5c = param_2[4];
      ...
      D3D8_DebugSetMute(0);
      if (local_8 != 0) goto LAB_00492579;
    }
    local_14 = param_2;
  }
  else {
...
joined_r0x00492769:
          if (((local_44 == 0) && (local_3c == local_4c)) && (local_40 == 0)) {
            uVar3 = 0;
            uVar4 = 0;
            if (local_38 == local_48) goto LAB_00492849;
          }
        }
        else if (((local_44 == 0) && (local_3c == (local_4c + 3 & 0xfffffffc))) && (local_40 == 0))
        {
          uVar3 = 0;
          uVar4 = 0;
          if (local_38 == (local_48 + 3 & 0xfffffffc)) goto LAB_00492849;
        }
      }
      else {
...
LAB_004926e2:
          ...
          goto joined_r0x00492769;
        }
        if (((local_64[0] == 0x33545844) || (local_64[0] == 0x34545844)) ||
           (local_64[0] == 0x35545844)) goto LAB_0049271e;
        if (local_64[0] == 0x59565955) goto LAB_004926e2;
        local_44 = local_34;
        local_40 = local_30;
        local_3c = local_2c;
        local_38 = local_28;
    ...
    if ((param_6 & 0x20000) == 0) {
      D3D8_DebugSetMute(1);
      iVar5 = (**(code **)(*param_2 + 0x1c))(param_2,&DAT_004db24c,&local_10);
      if (-1 < iVar5) {
