/*
 * Function: Level_InitMeshes5
 * Address: 0x00415d90
 * Signature: Level_InitMeshes5(...)
 *
 * Patterns: vtable dispatch, SEH frame, matrix math, level. Calls: Level_InitMeshes5, AthenaListObj_ctor, Vec3_Init, Matrix_Identity, CONCAT31, Level_SetObjectTransform, MeshBuffer_dtor. Offsets: 19, Lines: 129
 *
...
void __fastcall Level_InitMeshes5(int param_1)

{
  ...
  while( true ) {
    ...
    if (((iVar4 < 0) || (iStack_42c <= iVar4)) ||
       (iVar1 = *(int *)(iStack_24 + iVar4 * 4), iVar1 == 0)) goto LAB_00415e52;
...
LAB_00415e52:
  Vec3_Init(&stack0xfffff790,0x3db851ec,0x3f147ae1,0x3f6e147b);
