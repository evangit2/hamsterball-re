...
undefined4 __thiscall Mesh_CollectUniqueAttributes(void *this,undefined4 *param_1,uint *param_2)
...
LAB_0047e76a:
      ...
      if (*(int *)((int)this + 0x58) != 0) {
        ...
        do {
          puVar2 = puVar5;
          if ((*(short *)(local_18 + *(int *)((int)this + 0x40)) != -1) &&
            ...
            if (uVar3 == local_c) {
              if (local_c == local_24) {
                ...
                if (puVar2 == (undefined4 *)0x0) goto LAB_0047e76a;
                puVar6 = puVar2;
