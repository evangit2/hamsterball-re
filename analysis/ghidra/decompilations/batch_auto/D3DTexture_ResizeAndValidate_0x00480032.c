...
int __thiscall D3DTexture_ResizeAndValidate(void *this,uint param_1,uint param_2)

{
  ...
  if (local_3c < param_1) {
    iVar2 = (**(code **)(**(int **)((int)this + 0x24) + 0x60))
                      (*(int **)((int)this + 0x24),param_1 * 0xc,*(undefined4 *)((int)this + 0x18),
                       0x66,*(undefined4 *)((int)this + 0x10),&local_c);
    if (iVar2 < 0) goto LAB_004804ab;
    if (*(int *)((int)this + 0x58) != 0) {
      ...
      puVar6 = local_20;
      puVar7 = local_10;
      for (uVar4 = *(int *)((int)this + 0x58) * 3 & 0x3fffffff; uVar4 != 0; uVar4 = uVar4 - 1) {
        *puVar7 = *puVar6;
        puVar6 = puVar6 + 1;
        puVar7 = puVar7 + 1;
      }
      ...
      puVar6 = local_10 + *(int *)((int)this + 0x58) * 3;
      for (uVar4 = (param_1 - *(int *)((int)this + 0x58)) * 3 & 0x3fffffff; uVar4 != 0;
          uVar4 = uVar4 - 1) {
        *puVar6 = 0;
        puVar6 = puVar6 + 1;
      }
    ...
    if (((*(byte *)((int)this + 0xc) & 1) == 0) || (iVar2 = MeshContainer_Resize(), iVar2 != 0)) {
      ...
      if (((*(byte *)((int)this + 0xc) & 8) == 0) ||
         (iVar2 = WideArray_Grow((undefined4 *)((int)this + 0x4c),param_1,*(int *)((int)this + 0x58)
                                 ,&local_34), iVar2 != 0)) goto LAB_00480209;
    }
LAB_004801a4:
    iVar2 = -0x7ff8fff2;
  }
...
LAB_00480209:
    if (*(uint *)((int)this + 0x34) < param_2) {
      if (((*(byte *)((int)this + 0xc) & 2) != 0) &&
         (iVar2 = MeshContainer_GrowArray
                            ((undefined4 *)((int)this + 0x38),param_2,*(int *)((int)this + 0x30),
                             &local_40), iVar2 == 0)) goto LAB_004801a4;
      if ((*(byte *)((int)this + 0xc) & 0x20) == 0) {
        ...
        if (*(int *)((int)this + 0x30) != 0) {
          ...
          goto LAB_004804ab;
          uVar5 = *(int *)((int)this + 0x30) * *(int *)((int)this + 0x2c);
          puVar6 = local_18;
          puVar7 = local_14;
          ...
          uVar5 = (param_2 - *(int *)((int)this + 0x30)) * *(int *)((int)this + 0x2c);
          puVar6 = (undefined4 *)
    ...
    *(uint *)((int)this + 0x58) = param_1;
    ...
    if (((-1 < iVar2) &&
      ...
      if (((local_5c < *(uint *)((int)this + 0x34)) || (local_5c < 0x10000)) ||
         (local_60 < *(uint *)((int)this + 0x5c))) {
        *(uint *)((int)this + 0xc) = *(uint *)((int)this + 0xc) | 0x40;
      }
