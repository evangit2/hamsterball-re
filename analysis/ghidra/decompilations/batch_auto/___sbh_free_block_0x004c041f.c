...

{
  ...
  if ((local_8 & 1) == 0) {
    ...
    *piVar4 = *piVar4 + -1;
    if (*piVar4 == 0) {
      if (DAT_005369a4 != (uint *)0x0) {
        VirtualFree((LPVOID)(DAT_005369bc * 0x8000 + DAT_005369a4[3]),0x8000,0x4000);
        DAT_005369a4[2] = DAT_005369a4[2] | 0x80000000U >> ((byte)DAT_005369bc & 0x1f);
        *(undefined4 *)(DAT_005369a4[4] + 0xc4 + DAT_005369bc * 4) = 0;
        *(char *)(DAT_005369a4[4] + 0x43) = *(char *)(DAT_005369a4[4] + 0x43) + -1;
        if (*(char *)(DAT_005369a4[4] + 0x43) == '\0') {
          DAT_005369a4[1] = DAT_005369a4[1] & 0xfffffffe;
        }
        if (DAT_005369a4[2] == 0xffffffff) {
          VirtualFree((LPVOID)DAT_005369a4[3],0,0x8000);
          HeapFree(DAT_005369c0,0,(LPVOID)DAT_005369a4[4]);
          _memmove(DAT_005369a4,DAT_005369a4 + 5,
                   (DAT_005369a8 * 0x14 - (int)DAT_005369a4) + -0x14 + DAT_005369ac);
          DAT_005369a8 = DAT_005369a8 + -1;
          if (DAT_005369a4 < param_1) {
            param_1 = param_1 + -5;
          }
          DAT_005369b4 = DAT_005369ac;
        }
      }
      DAT_005369a4 = param_1;
      DAT_005369bc = uVar14;
    }
  }
  return;
