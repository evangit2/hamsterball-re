...
int __cdecl Audio_CodecAllocSamples8(int *param_1,int param_2,uint param_3,uint param_4)
  ...
  *(uint *)(iVar2 + 0x4c) = uVar1;
  ...
  if (param_4 != 0) {
    do {
      ...
      puVar3 = Audio_CodecAllocSimple(this_00,param_1,param_2,uVar1 * param_3);
