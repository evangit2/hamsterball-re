...
undefined4 __cdecl
PNG_GetIHDR(int param_1,uint *param_2,uint *param_3,uint *param_4,uint *param_5,uint *param_6,
  ...
  if ((((param_1 == 0) || (param_2 == (uint *)0x0)) || (param_3 == (uint *)0x0)) ||
    ...
    *param_6 = (uint)*(byte *)((int)param_2 + 0x19);
    ...
    if ((uint)(0x7fffffff / (ulonglong)(uint)((int)(*param_5 * uVar2 + 7) >> 3)) < *param_3) {
      seh_filter_invoke(param_1,"Width too large for libpng to process image data.");
    }
    uVar3 = 1;
  }
  return uVar3;
