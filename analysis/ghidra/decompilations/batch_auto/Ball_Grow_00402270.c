 ...
 * Function: Ball_Grow
 * Address: 0x00402270
 * Signature: void __fastcall Ball_Grow(int param_1)
 *
 * Description:
 * Ends the ball's falling state and restores normal physics parameters.
 * This is the counterpart to Ball_Shrink (0x402200).
 *
 * Sets three values:
 ...
 *      the normal gameplay value — Ball_Shrink had set it to 13.0f)
 *   3. ball+0x188 = 0x40A00000 = 5.0f (restores timer/scale to 5.0,
 *      Ball_Shrink had set it to 2.5f)
 *
 * Cross-references:
...
void __fastcall Ball_Grow(int param_1)
