...
void __cdecl Audio_UpsampleRows(int param_1,undefined4 *param_2,undefined4 *param_3,int *param_4)

{
  ...
  if (0 < *(int *)(param_1 + 0x110)) {
    ...
    do {
      ...
      if (1 < uVar6) {
        Array_CopyElements(iVar3,local_c,iVar3,local_c + 1,uVar6 - 1,*(uint *)(param_1 + 0x5c));
      }
