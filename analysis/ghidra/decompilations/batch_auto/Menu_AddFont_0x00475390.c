...
void __thiscall Menu_AddFont(void *this,undefined4 param_1,char *param_2)

{
  ...
  StdString_Assign(this_00,(undefined4 *)&DAT_004da12c,(uint)(pcVar2 + -0x4da12c));
  *(undefined4 *)((int)this_00 + 0x38) = param_1;
  ...
  AthenaList_Append((void *)((int)this + 0x14c4),(int)this_00);
  *(void **)((int)this + 0x2d54) = (void *)((int)this + 0x14c4);
  return;
}
