 ...
 *
 * Description:
 * Constructor for RaceResults display. Calls RumbleScore_ctor, overrides vtable to 0x4D6B10. Initializes Vec3 at +0x28. Calls Matrix_Scale4x4 (0.5,0.5,0.5,1.0), stores result at +0x2C through +0x38. Calls Matrix_Identity. 1 call.
 *
 * Struct offsets:
