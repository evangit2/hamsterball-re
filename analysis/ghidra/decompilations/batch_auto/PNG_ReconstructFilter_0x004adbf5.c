...
void __cdecl PNG_ReconstructFilter(int param_1,int param_2,byte *param_3,byte *param_4,int param_5)

{
  ...
  if (param_5 != 0) {
    if (param_5 == 1) {
      ...
      seh_filter_invoke(param_1,"Ignoring bad adaptive filter type");
      *param_3 = 0;
    }
  }
  return;
