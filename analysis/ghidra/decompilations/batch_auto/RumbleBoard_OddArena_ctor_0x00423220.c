 ...
 *
 * Description:
 * Constructor for Odd Arena. Calls ArenaBoard_ctor, sets vtable, names 'RumbleBoard (Odd Arena)' / 'ODD ARENA'. Clears flag at +0x4348. Vec3 init (1,0.5,0).
 *
 * Struct offsets: +0x4348 (flag), +0x868, +0x29B4
