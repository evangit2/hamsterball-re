 ...
 * Address: 0x00410670
 * Signature: Scene_RenderReflectiveObjects(...)
 *
 * Patterns: vtable dispatch, SEH frame, rendering, scene, level. Calls: Scene_RenderReflectiveObjects, Level_RenderDynamicObjects, Graphics_SetProjection, RenderContext_Init, Matrix4_Identity. Offsets: 8, Lines: 76
 *
...
void __thiscall Scene_RenderReflectiveObjects(void *this,void *param_1)

{
  ...
  *(float *)((int)param_1 + 0x794) = fVar2;
  ...
  iVar4 = (int)this + 0x438c;
  pfVar3 = (float *)((int)this + 0x644c);
  param_1 = (void *)0x8;
  do {
