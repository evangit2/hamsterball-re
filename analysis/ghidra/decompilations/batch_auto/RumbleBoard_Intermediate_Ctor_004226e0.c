/*
 * Function: RumbleBoard_Intermediate_Ctor
 * Address: 0x004226e0
 * Signature: void * __thiscall RumbleBoard_Intermediate_Ctor(void *this,int param_1)
 *
 * Patterns: SEH frame, matrix math, board. Calls: RumbleBoard_Intermediate_Ctor, RumbleBoard_ctor, RumbleBoard, Vec3_Init, Matrix_Identity. Offsets: 10, Lines: 28
 *
 * Decompiled from Hamsterball.exe (Athena Engine, PE32 i386)
 */

void * __thiscall RumbleBoard_Intermediate_Ctor(void *this,int param_1)

{
  ...
  local_4 = 0;
  *(undefined ***)this = &PTR_RumbleBoard_DeletingDtor_004d15c0;
