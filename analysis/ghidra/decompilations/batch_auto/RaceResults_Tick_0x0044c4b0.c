 ...
 *
 * Description:
 * Per-frame tick for race results display. Increments frame counter at +0x10. If past max (+0x14) and active (+0x19), decrements counter at parent+0x8B4. Handles key input: Input_CheckKeyCombo sets +0x58/+0x59 flags. Calls RumbleBoard_TickTimer on +0x3C. Decrements timer at +0x28 by _DAT_004D6CB0.
 *
 * Struct offsets:
