...

{
  ...
  local_24 = 0;
  __lock(1);
  for (_Index = 0; _Index < DAT_005369a0; _Index = _Index + 1) {
    _File = *(void **)(DAT_00535988 + _Index * 4);
    if ((_File != (void *)0x0) && ((*(byte *)((int)_File + 0xc) & 0x83) != 0)) {
      __lock_file2(_Index,_File);
      pFVar1 = *(FILE **)(DAT_00535988 + _Index * 4);
      ...
      CRT_UnlockFile2Indexed();
    }
  }
  CRT_LeaveCriticalSection1b();
  if (param_1 != 1) {
    local_20 = local_24;
  }
  return local_20;
