 ...
 * Address: 0x00422c70
 * Signature: Scene_ComputeArenaLighting(...)
 *
 * Patterns: vtable dispatch, SEH frame, scene. Calls: Scene_ComputeArenaLighting, AthenaList_Init, AthenaList_NextIndex, ABS, AthenaList_Append, AthenaList_GetSize, AthenaList_MergeSorted, RNG_Rand. Offsets: 11, Lines: 147
 *
...
float * __thiscall Scene_ComputeArenaLighting(void *this,float *param_1,int param_2)
  ...
  if (*(int *)(*(int *)((int)this + 0x878) + 0xb28 + param_2 * 4) == 99) {
    ...
    if (piVar1[0x202] == 0) {
      ...
      *(undefined4 *)((int)this + iVar7 * 4 + 0x29dc) = 0;
      ...
      (**(code **)(*piVar1 + 0x14))
                (fVar3 * fVar5 * _DAT_004cf4d8,0,fVar5 * local_430 * _DAT_004cf4d8);
      *param_1 = 0.0;
      param_1[1] = 0.0;
      param_1[2] = 0.0;
      local_4 = 0xffffffff;
