...
/* Ball_ApplyForceWithMultipliers(this, dirX, dirY, dirZ, multiplier): Adds force to velocity
   accumulators at +0x170/174/178. Guards: !teleport,!block,+0x808==0,impact_count<81. Modifiers:
   impact damping, speed flag, momentum transfer, friction. Sets auto-rotation atan2. */

void __thiscall
Ball_ApplyForceWithMultipliers(void *this,float param_1,float param_2,float param_3,float param_4)
