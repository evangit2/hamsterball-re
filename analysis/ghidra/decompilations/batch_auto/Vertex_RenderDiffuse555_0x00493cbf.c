...
void __thiscall Vertex_RenderDiffuse555(void *this,uint param_1,uint param_2,int param_3)
  ...
  if (*(int *)((int)this + 0x1058) != 0) {
    ...
    do {
      ...
      *puVar8 = (ushort)((((int)ROUND(fVar5 + *(float *)(iVar4 + param_3)) << 5 |
                          (int)ROUND(*pfVar1 * _DAT_004d5c24 + fVar5)) << 5 |
                         (int)ROUND(*(float *)(iVar2 + param_3) * _DAT_004d5c24 + fVar5)) << 5) |
                (ushort)(int)ROUND(*(float *)(iVar3 + param_3) * _DAT_004d5c24 + fVar5);
      puVar8 = puVar8 + 1;
      uVar9 = uVar9 + 1;
