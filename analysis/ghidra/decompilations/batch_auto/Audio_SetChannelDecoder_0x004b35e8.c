...
void __cdecl Audio_SetChannelDecoder(undefined *param_1)
...
LAB_004b36a3:
        ...
        if (iVar8 == 2) {
          param_1 = IDCT_2x2_Scalar;
          goto LAB_004b36a3;
        }
        if (iVar8 == 4) {
          param_1 = IDCT_8x8_Scalar;
          goto LAB_004b36a3;
        }
        if (iVar8 == 8) {
          iVar8 = *(int *)(puVar3 + 0x44);
          if (iVar8 == 0) {
            param_1 = IDCT_8x8_Dispatch;
            goto LAB_004b36a3;
          }
          if (iVar8 == 1) {
            param_1 = IDCT_4x4_Dispatch;
            local_8 = 1;
          }
          else {
            if (iVar8 != 2) {
      ...
      if ((((char)piVar11[3] != '\0') && (*piVar10 != local_8)) && (iVar8 = piVar11[10], iVar8 != 0)
        ...
        *piVar10 = local_8;
        if (local_8 == 0) {
          ...
          psVar5 = &DAT_004e9220;
          do {
            *(short *)(iVar9 + -0x4e9220 + (int)psVar5) =
                 (short)((int)*(short *)(iVar8 + -0x4e9220 + (int)psVar5) * (int)*psVar5 + 0x800 >>
                        0xc);
            psVar5 = psVar5 + 1;
          } while ((int)psVar5 < 0x4e92a0);
        }
        else if (local_8 == 2) {
          iVar9 = piVar11[0xb];
          iVar4 = 0;
          local_c = (double *)&DAT_004e92a0;
          do {
            pdVar7 = (double *)&DAT_004e92a0;
            do {
              dVar2 = *pdVar7;
              pdVar7 = pdVar7 + 1;
              *(float *)(iVar9 + iVar4 * 4) =
              ...
              iVar4 = iVar4 + 1;
            } while ((int)pdVar7 < 0x4e92e0);
            local_c = local_c + 1;
          } while ((int)local_c < 0x4e92e0);
        }
        else {
          *(undefined4 *)(*(int *)puVar3 + 0x14) = 0x2f;
          (*(code *)**(undefined4 **)puVar3)(puVar3);
