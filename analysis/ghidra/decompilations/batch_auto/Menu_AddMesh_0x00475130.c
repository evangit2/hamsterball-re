...
void __thiscall Menu_AddMesh(void *this,undefined4 param_1,char *param_2)

{
  ...
  StdString_Assign(this_00,(undefined4 *)&DAT_004da14c,(uint)(pcVar2 + -0x4da14c));
  *(undefined4 *)((int)this_00 + 0x38) = param_1;
  ...
  AthenaList_Append((void *)((int)this + 0x2524),(int)this_00);
  *(void **)((int)this + 0x2d54) = (void *)((int)this + 0x2524);
  return;
}
