...
void __thiscall D3DX_ProcessVertices_ToIntensity16(void *this,uint param_1,uint param_2,int param_3)

{
  ...
  if (*(int *)((int)this + 0x1058) != 0) {
    ...
    do {
      ...
      *puVar4 = (int)ROUND(*(float *)(iVar3 + 4 + param_3) * _DAT_004dc070 + fVar1) << 0x10 |
                (int)ROUND(*(float *)(iVar3 + param_3) * _DAT_004dc070 + fVar1);
      puVar4 = puVar4 + 1;
      uVar5 = uVar5 + 1;
      iVar3 = iVar3 + 0x10;
