...
undefined8 * Matrix_Inverse4x4_SSE2(undefined8 *param_1,undefined4 *param_2,undefined8 *param_3)

{
  ...
  uVar9 = PackedFloatingMUL(CONCAT44((int)uVar9,(int)uVar13),_DAT_004dbc50);
  uStack_34 = (undefined4)((ulonglong)uVar19 >> 0x20);
  uVar13 = CONCAT44(uStack_34,(int)((ulonglong)uVar10 >> 0x20));
  uVar15 = PackedFloatingMUL(CONCAT44(*(undefined4 *)(param_3 + 2),(int)*param_3),_DAT_004dbc50);
  ...
  uVar13 = PackedFloatingMUL(uVar9,_DAT_004dbc50);
