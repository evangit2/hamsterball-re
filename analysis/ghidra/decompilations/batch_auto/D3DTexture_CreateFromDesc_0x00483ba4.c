...
int D3DTexture_CreateFromDesc(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -0x14) = 0;
  ...
  if ((uVar2 == 0) || ((uVar2 & 1) != 0)) {
    iVar5 = -0x7789f794;
LAB_00483d36:
    if (piVar6 == (int *)0x0) goto LAB_00483d5b;
        ...
        if ((uVar3 & 1) != 0) {
          ...
          *(int **)(unaff_EBP + -0x18) = piVar6;
          if (piVar6 == (int *)0x0) {
            ...
            iVar5 = D3DTexture_CopyIndexData(this,piVar6);
            if (-1 < iVar5) {
        ...
        if ((*(uint *)((int)this + 0x58) < 0x10000) && (*(uint *)((int)this + 0x30) < 0x10000)) {
          ...
          *(int **)(unaff_EBP + -0x14) = piVar6;
          if (piVar6 == (int *)0x0) {
            ...
            iVar5 = D3DTexture_CopyLockedData(this,piVar6);
            if (-1 < iVar5) {
              if (*(int *)(unaff_EBP + -0x10) != 0) {
                *(uint *)((int)this + 0xc) = *(uint *)((int)this + 0xc) | 0x20;
                piVar6[10] = *(int *)((int)this + 0x28);
