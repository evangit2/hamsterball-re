/*
 * Function: RumbleCollision_Level_Dtor
 * Address: 0x00437380
 * Signature: void __fastcall RumbleCollision_Level_Dtor(undefined4 *param_1)
 * Parameters:
 ...
 *   1. Sets vtable to PTR_RumbleCollision_DeletingDtor (0x4D5A70)
 *   2. Calls RumbleBoard_CleanupTimer on +0x43B (cleans up a timer used for
 ...
 *
 * Cross-references:
 *   Called from RumbleCollision_DeletingDtor (0x43E5C3) — UNCONDITIONAL_CALL
 *
