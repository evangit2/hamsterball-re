...

{
  ...
  uVar9 = (DAT_004fb198 & in_MM0) >> 1 | DAT_004fb198 & in_MM1;
  uVar3 = in_MM1 & DAT_004fb19c;
  uVar1 = in_MM0 & DAT_004fb19c;
  ...
  uVar5 = PackedFloatingADD((ulonglong)DAT_004fb1d0,uVar4);
  uVar6 = PackedFloatingMUL((ulonglong)DAT_004fb1dc,uVar4);
  uVar5 = PackedFloatingMUL(uVar5,uVar4);
  uVar6 = PackedFloatingADD(uVar6,(ulonglong)DAT_004fb1d8);
  uVar5 = PackedFloatingADD(uVar5,(ulonglong)DAT_004fb1cc);
  uVar6 = PackedFloatingMUL(uVar6,uVar4);
  uVar5 = PackedFloatingMUL(uVar5,uVar4);
  uVar6 = PackedFloatingADD(uVar6,(ulonglong)DAT_004fb1d4);
  uVar5 = PackedFloatingADD(uVar5,(ulonglong)DAT_004fb1c8);
  uVar4 = PackedFloatingMUL(uVar4,uVar6);
  uVar4 = PackedFloatingMUL(uVar4,uVar2);
  uVar6 = FloatingReciprocalAprox((ulonglong)DAT_004fb1d4,uVar5);
  uVar8 = (int)uVar9 << 1;
  ...
  uVar2 = PackedFloatingSUB(~(ulonglong)(uint)((int)uVar7 >> 0x1f) &
                            (ulonglong)(uVar8 ^ DAT_004fb1f8),(ulonglong)DAT_004fb1f8);
  uVar1 = PackedFloatingADD(uVar1 | uVar8 ^ uVar7,uVar2);
  return uVar1 | DAT_004fb198 & uVar9;
}
