...
void Vec2_CatmullRom2(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                     float param_6)

{
  ...
  *param_1 = ((fVar2 - fVar1) * *param_5 + fVar3 * *param_4 + fVar4 * *param_3 + fVar5 * *param_2) *
  ...
  param_1[1] = (fVar5 * param_2[1] +
               fVar4 * param_3[1] + fVar3 * param_4[1] + (fVar2 - fVar1) * param_5[1]) * fVar6;
  return;
}
