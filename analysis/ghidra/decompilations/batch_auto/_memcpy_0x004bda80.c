...

{
  ...
  if ((_Src < _Dst) && (_Dst < (void *)(_Size + (int)_Src))) {
    ...
    if (((uint)puVar4 & 3) == 0) {
      ...
      if (7 < uVar1) {
        ...
        case 0:
          return _Dst;
        case 2:
          goto switchD_004bdc3b_caseD_2;
        case 3:
          goto switchD_004bdc3b_caseD_3;
        }
        goto switchD_004bdc3b_caseD_1;
      }
    }
    else {
      switch(_Size) {
      case 0:
        goto switchD_004bdc3b_caseD_0;
      case 1:
        goto switchD_004bdc3b_caseD_1;
      case 2:
        goto switchD_004bdc3b_caseD_2;
    ...
    switch(uVar2) {
    case 1:
switchD_004bdc3b_caseD_1:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      return _Dst;
    case 2:
switchD_004bdc3b_caseD_2:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar3 + 2);
      return _Dst;
    case 3:
switchD_004bdc3b_caseD_3:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar3 + 2);
      *(undefined1 *)((int)puVar4 + 1) = *(undefined1 *)((int)puVar3 + 1);
      return _Dst;
    }
switchD_004bdc3b_caseD_0:
    return _Dst;
  }
  puVar3 = _Dst;
  if (((uint)_Dst & 3) == 0) {
    ...
    if (7 < uVar1) {
      ...
      case 0:
        return _Dst;
      case 2:
        goto switchD_004bdab5_caseD_2;
      case 3:
        goto switchD_004bdab5_caseD_3;
      }
      goto switchD_004bdab5_caseD_1;
    }
  }
  else {
    switch(_Size) {
    case 0:
      goto switchD_004bdab5_caseD_0;
    case 1:
      goto switchD_004bdab5_caseD_1;
    case 2:
      goto switchD_004bdab5_caseD_2;
