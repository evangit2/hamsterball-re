 ...
 *
 * Patterns: vtable dispatch, SEH frame, rendering, level. Calls: Level_RenderDynamicObjects, AthenaList_NextIndex, Timer_Init, Gfx_SetPositionAndRender, Gfx_ScaleX, Gfx_ScaleZ, Gfx_SetPosition, WaterRipple_Render. Offsets: 16, Lines: 57
 *
 * Decompiled from Hamsterball.exe (Athena Engine, PE32 i386)
 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Level_RenderDynamicObjects(this): 3-phase. 1)Sky: skybox vtable[48] or skydome 2)Water ripples:
   iterate list, Gfx_SetPosition+ScaleXZ+WaterRipple_Render 3)dynamic_object->vtable[8]. See
...

{
  ...
  *(undefined4 *)(param_1 + 0x2168 + iVar2 * 4) = 0;
  ...
  while (iVar3 != 0) {
    ...
    WaterRipple_Render(*(void **)(param_1 + 0x3f18),(float)&stack0xffffffa8);
