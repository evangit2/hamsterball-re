 ...
 *
 * Description:
 * Constructor for TourneyMenu. Calls SimpleMenu_ctor, overrides vtable to 0x4D83F0. RumbleBoard_InitTimer at +0xCDC. Name 'Tourney Menu'. Calls Scene_UpdateChildren, UIList_AddItem for 'PLAY!' button. Checks tournament state at App+0x220 (+0x90=loss, +0x95=lost flag, +0x96=won flag). 4+ calls.
 *
 * Struct offsets:
