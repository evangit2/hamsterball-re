...
undefined4 * __thiscall Audio_CodecAllocSimple(void *this,int *param_1,int param_2,uint param_3)

{
  ...
  sVar6 = param_3 + 0x10;
  puVar5 = (undefined4 *)CRT_Malloc(param_1,sVar6);
  if (puVar5 == (undefined4 *)0x0) {
    DSound_SetVolume(sVar6,4);
  }
