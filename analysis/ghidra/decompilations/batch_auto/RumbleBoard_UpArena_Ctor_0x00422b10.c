 ...
 *
 * Description:
 * Constructor for Up Arena. Calls RumbleBoard_ctor, sets vtable, names 'RumbleBoard (Up Arena)' / 'UP ARENA'. Creates MeshWorld 'levels\\arena-up' and CollisionLevel. Initializes Vec3 (1,0,1).
 *
 * Struct offsets: +0x868 (board name), +0x4344 (game mode), +0x29B4 (display name)
