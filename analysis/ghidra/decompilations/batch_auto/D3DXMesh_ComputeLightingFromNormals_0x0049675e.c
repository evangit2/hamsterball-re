...

{
  ...
  if ((*(int *)(param_1 + 0x108c) != 0) && (*(int *)(param_1 + 0x1090) != 0)) {
    ...
    if (local_c < *(uint *)(param_1 + 0x1078)) {
      do {
        iVar2 = (int)ROUND(pfVar1[2] * _DAT_004dc114 +
                           pfVar1[1] * _DAT_004dc110 + *pfVar1 * _DAT_004dc118 + _DAT_004cf3f0) +
                0x10;
        iVar4 = (int)ROUND(pfVar1[5] * _DAT_004dc110 +
                           pfVar1[6] * _DAT_004dc114 + pfVar1[4] * _DAT_004dc118 + _DAT_004cf3f0) +
                0x10;
        iVar3 = (int)ROUND(((pfVar1[2] * _DAT_004dc10c - pfVar1[1] * _DAT_004dc108) -
                           *pfVar1 * _DAT_004dc104) + _DAT_004cf3f0) + 0x80;
        iVar5 = (int)ROUND((*pfVar1 * _DAT_004dc10c -
                           (pfVar1[2] * _DAT_004dc0fc + pfVar1[1] * _DAT_004dc100)) + _DAT_004cf3f0)
                + 0x80;
        if (iVar2 < 0) {
          iVar2 = 0;
        }
