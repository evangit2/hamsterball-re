...
uint __thiscall MeshWorld_Parse(void *this,char *param_1,char param_2)

{
  ...
  StreamReader_InitVtbl(&local_594);
  local_4 = 0;
  ...
  if (puVar8 == (undefined4 *)0x0) {
    ...
    local_5a8 = CreateMeshBuffer(puVar8);
  }
  ...
  *(undefined1 *)((int)puVar17 + 5) = DAT_004d9e5c;
  bVar7 = StreamReader_OpenFile(&local_594,local_524);
  if (bVar7) {
    bVar7 = false;
    bVar5 = false;
    bVar6 = false;
    pcVar10 = StreamReader_ReadLine(&local_594,'\x01');
    while (pcVar10 != (char *)0x0) {
      pcVar10 = strtok(pcVar10," ");
      iVar20 = 0x10;
      bVar26 = true;
      pcVar13 = pcVar10;
      pcVar25 = "*MATERIAL_COUNT";
      do {
        if (iVar20 == 0) break;
        iVar20 = iVar20 + -1;
        bVar26 = *pcVar13 == *pcVar25;
        pcVar13 = pcVar13 + 1;
        pcVar25 = pcVar25 + 1;
      } while (bVar26);
      if (bVar26) {
        pcVar10 = strtok((char *)0x0," ");
        lVar11 = _atol(pcVar10);
        *(long *)((int)this + 0x24) = lVar11;
        ...
        if (plVar12 == (long *)0x0) {
          ...
          plVar24 = plVar12 + 1;
          *plVar12 = lVar11;
          _eh_vector_constructor_iterator_(plVar24,0x50,lVar11,RenderContext_Init,Matrix4_Identity);
        }
        local_4 = (uint)local_4._1_3_ << 8;
      ...
      if ((bVar26) && (bVar7)) {
        ...
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x14 + *(int *)((int)this + 0x28)) = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x18 + *(int *)((int)this + 0x28)) = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x1c + *(int *)((int)this + 0x28)) = (float)dVar27;
      ...
      if ((bVar26) && (bVar5)) {
        ...
        iVar20 = (short)local_5b8 * 0x50;
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 4 + *(int *)((int)this + 0x28)) = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 8 + *(int *)((int)this + 0x28)) = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0xc + *(int *)((int)this + 0x28)) = (float)dVar27;
      ...
      if ((bVar26) && (bVar6)) {
        ...
        iVar20 = (short)local_5b8 * 0x50;
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x24 + *(int *)((int)this + 0x28)) = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x28 + *(int *)((int)this + 0x28)) = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x2c + *(int *)((int)this + 0x28)) = (float)dVar27;
      ...
      bVar26 = true;
      pcVar13 = pcVar10;
      pcVar25 = "*MATERIAL_SHINESTRENGTH";
      do {
        if (iVar20 == 0) break;
        iVar20 = iVar20 + -1;
        bVar26 = *pcVar13 == *pcVar25;
      ...
      if (bVar26) {
        ...
        *(float *)((short)local_5b8 * 0x50 + 0x44 + *(int *)((int)this + 0x28)) =
             (float)dVar27 * _DAT_004cf454;
      }
      iVar20 = 0x17;
      bVar26 = true;
      pcVar13 = pcVar10;
      pcVar25 = "*MATERIAL_TRANSPARENCY";
      do {
        if (iVar20 == 0) break;
        iVar20 = iVar20 + -1;
        bVar26 = *pcVar13 == *pcVar25;
      ...
      if (bVar26) {
        ...
        iVar20 = (short)local_5b8 * 0x50;
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x10 + *(int *)((int)this + 0x28)) = _DAT_004cf310 - (float)dVar27;
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x20 + *(int *)((int)this + 0x28)) = _DAT_004cf310 - (float)dVar27;
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x40 + *(int *)((int)this + 0x28)) = _DAT_004cf310 - (float)dVar27;
        dVar27 = _atof(pcVar10);
        *(float *)(iVar20 + 0x30 + *(int *)((int)this + 0x28)) = _DAT_004cf310 - (float)dVar27;
        dVar27 = _atof(pcVar10);
        if ((double)_DAT_004cf310 - dVar27 != _DAT_004cf3c8) {
      ...
      if (bVar26) {
        pcVar10 = strtok((char *)0x0," ");
        pcVar10 = pcVar10 + 1;
        pcVar13 = strchr(pcVar10,0x2f22);
        if (pcVar13 != (char *)0x0) {
          *pcVar13 = '\0';
        }
        pvVar14 = Graphics_FindOrCreateTexture(*(void **)((int)this + 4),pcVar10,'\x01');
        *(void **)((short)local_5b8 * 0x50 + 0x48 + *(int *)((int)this + 0x28)) = pvVar14;
      }
      iVar20 = 0xc;
      bVar26 = true;
      pcVar13 = pcVar10;
      ...
      if (bVar26) {
        ...
        local_4 = (uint)local_4._1_3_ << 8;
        AthenaList_Free((int)(local_5a8 + 3));
        *(undefined1 *)(local_5a8 + 0x217) = 0;
        AthenaList_Append((void *)((int)this + 0x2c),(int)local_5a8);
      }
      iVar20 = 0xb;
      bVar26 = true;
      pcVar13 = pcVar10;
      ...
      if (bVar26) {
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        local_5a8[0x21a] = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        local_5a8[0x21c] = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        local_5a8[0x21b] = (float)dVar27;
      }
      iVar20 = 0x10;
      bVar26 = true;
      pcVar13 = pcVar10;
      pcVar25 = "*MESH_NUMVERTEX";
      do {
        if (iVar20 == 0) break;
        iVar20 = iVar20 + -1;
        bVar26 = *pcVar13 == *pcVar25;
      ...
      if (bVar26) {
        ...
        dVar27 = _atof(pcVar10);
        pcVar10 = strtok((char *)0x0," ");
        dVar28 = _atof(pcVar10);
        *(float *)((int)local_5a4 + lVar11 * 8) = (float)dVar27;
        *(float *)((int)local_5a4 + lVar11 * 8 + 4) = (float)dVar28;
      }
      iVar20 = 0xb;
      bVar26 = true;
      pcVar13 = pcVar10;
      ...
      if (bVar26) {
        ...
        *puVar8 = *puVar17;
        ...
        AthenaList_Append(local_5a8 + 3,(int)puVar8);
      }
      iVar20 = 0xc;
      bVar26 = true;
      pcVar13 = pcVar10;
      ...
      if (bVar26) {
        ...
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        local_548 = (float)dVar27;
        dVar27 = _atof(pcVar10);
        local_53c = (float)dVar27;
        dVar27 = _atof(pcVar10);
        local_530 = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        local_544 = (float)dVar27;
        dVar27 = _atof(pcVar10);
        local_538 = (float)dVar27;
        dVar27 = _atof(pcVar10);
        local_52c = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        local_540 = (float)dVar27;
        dVar27 = _atof(pcVar10);
        local_534 = (float)dVar27;
        dVar27 = _atof(pcVar10);
        local_528 = (undefined1  [4])(float)dVar27;
      ...
      if (bVar26) {
        ...
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        fStack_554 = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        fStack_550 = (float)dVar27;
        pcVar10 = strtok((char *)0x0," ");
        dVar27 = _atof(pcVar10);
        fStack_54c = (float)dVar27;
        Graphics_InitShaderDispatch();
    ...
    _free(local_5a4);
    if (param_2 == '\x01') {
      MeshWorld_ClearObjectLists((int)this);
    }
    else {
      *(undefined4 *)((int)this + 0x34) = 0;
      ...
      while (iVar20 != 0) {
        ...
        AthenaList_Free((int)auStack_424);
        *(undefined4 *)(iVar20 + 0x14) = 0;
        ...
        while (puVar8 != (undefined4 *)0x0) {
          ...
          AthenaList_Append(auStack_424,(int)puVar18);
          iVar21 = *(int *)(iVar20 + 0x14);
          if (*(int *)(iVar20 + 0x10) <= iVar21) break;
          puVar8 = *(undefined4 **)(*(int *)(iVar20 + 0x418) + iVar21 * 4);
          *(int *)(iVar20 + 0x14) = iVar21 + 1;
        }
        AthenaList_Free(iVar20 + 0xc);
        AthenaList_MergeSorted((void *)(iVar20 + 0xc),(int)auStack_424);
    ...
    _free(local_5b0);
    local_4 = 0xffffffff;
    uVar19 = FileHandle_Dtor(&local_594);
    uVar9 = CONCAT31((int3)((uint)uVar19 >> 8),1);
  }
  else {
    local_4 = 0xffffffff;
    uVar9 = FileHandle_Dtor(&local_594);
