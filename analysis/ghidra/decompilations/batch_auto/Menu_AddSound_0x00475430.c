...
void __thiscall Menu_AddSound(void *this,undefined4 param_1,char *param_2,undefined4 param_3)

{
  ...
  StdString_Assign(this_00,(undefined4 *)"SOUND",(uint)(pcVar2 + -0x4da124));
  ...
  *(undefined4 *)((int)this_00 + 0x44) = param_3;
  AthenaList_Append((void *)((int)this + 0x10ac),(int)this_00);
  *(void **)((int)this + 0x2d54) = (void *)((int)this + 0x10ac);
  return;
}
