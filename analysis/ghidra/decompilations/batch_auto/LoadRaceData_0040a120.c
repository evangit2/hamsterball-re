 ...
 * Address: 0x0040a120
 * Signature: void __thiscall LoadRaceData(void *this,char *param_1)
 *
 * Patterns: vtable dispatch, SEH frame, rendering. Calls: LoadRaceData, Sprite_DrawColoredRect, FileHandle_Open, MWParser_ReadTag, __stricmp, CONCAT31, AthenaString_Set, _atof. Offsets: 13, Lines: 98
 *
