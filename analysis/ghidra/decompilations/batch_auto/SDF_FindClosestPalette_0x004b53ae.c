...
void __cdecl SDF_FindClosestPalette(int param_1,int param_2,int param_3)
...
LAB_004b5466:
        ...
        if (iVar4 < (int)uVar3) {
          ...
          iVar7 = 0;
          if ((int)uVar3 <= local_1c) goto LAB_004b5466;
        }
      }
      iVar4 = (uVar3 - iVar5) * 2;
...
LAB_004b552a:
        ...
        else if ((int)uVar3 <= local_28) goto LAB_004b552a;
      }
