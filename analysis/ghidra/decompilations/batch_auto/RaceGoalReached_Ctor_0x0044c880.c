 ...
 *
 * Description:
 * Constructor for 'GOAL REACHED!' display. Stores parent at +4, param_2 at +8, App at +0xC. Increments active count at parent+0x8B4. Sets max frames=100 (+0x14). Vtable→0x4D6CF0. Initializes SceneObject_EmptyListCtor at +0x90, RumbleBoard_InitTimer at +0x4C4. Sets 'GOAL REACHED!' text at +0x24. Width=800 (+0x20/+0x4C0). 1 call.
 *
 * Struct offsets:
