...
void __thiscall D3DX_ProcessVertices_ToDword(void *this,uint param_1,uint param_2,int param_3)

{
  ...
  if (*(int *)((int)this + 0x1058) != 0) {
    ...
    do {
      ...
      iVar3 = iVar6 + 8;
      iVar6 = iVar6 + 0x10;
      *puVar7 = ((int)ROUND(*pfVar1 * _DAT_004cf304 + fVar4) << 8 |
                (int)ROUND(*(float *)(iVar2 + param_3) * _DAT_004cf304 + fVar4)) << 8 |
                (int)ROUND(*(float *)(iVar3 + param_3) * _DAT_004cf304 + fVar4);
      puVar7 = puVar7 + 1;
      uVar8 = uVar8 + 1;
