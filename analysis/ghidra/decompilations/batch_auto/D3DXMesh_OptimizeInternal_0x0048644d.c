...

{
  ...
  if ((local_3c != 0) && (((uint)param_1 & 0x40000000) == 0)) {
    ...
    local_8 = MeshData_SplitShortVertsByAttr(this,(int *)&local_40,&local_1c);
    if (local_8 < 0) goto LAB_00486a55;
  ...
  if (((local_10 != (uint *)0x0) && (local_c != (uint *)0x0)) && (local_14 != (void *)0x0)) {
    ...
    if ((local_4c == 0) ||
      ...
      if (((uint)param_1 & 0x40000000) == 0) {
        local_8 = Mesh_BuildAttributeIndices(this,(int)local_10,(int)local_c,(int)local_14);
        if (local_8 < 0) goto LAB_00486a55;
      }
      else {
        uVar1 = 0;
      ...
      if (((local_3c != 0) && (((uint)param_1 & 0x40000000) == 0)) &&
         (local_8 = Mesh_SortByAttribute
                              (this,(int)local_10,(int)local_c,(int)local_14,
                               (uint)param_1 & 0x10000000), local_8 < 0)) goto LAB_00486a55;
      ...
      local_8 = MeshData_OptimizeFaceOrder(this,(int)local_10,(int)local_14);
      if (local_8 < 0) goto LAB_00486a55;
      if (local_4c != 0) {
        puVar7 = local_c;
        puVar8 = local_2c;
        ...
        local_8 = D3DXMesh_ConvertAdjacencyToStrip16();
        if (local_8 < 0) goto LAB_00486a55;
        pvVar2 = operator_new(*(int *)((int)this + 0x30) << 2);
        local_44 = pvVar2;
        if (pvVar2 == (void *)0x0) goto LAB_00486a4d;
        if (local_3c == 0) {
          local_8 = MeshData_GenerateAdjacencyShort(this,(int)local_c,(int)pvVar2);
          if (local_8 < 0) goto LAB_00486a55;
          uVar1 = 0;
          if (*(int *)((int)this + 0x30) != 0) {
            do {
        ...
        puVar7 = local_10;
        local_8 = MeshData_OptimizeFaceOrder(this,(int)local_10,(int)pvVar2);
        if (local_8 < 0) goto LAB_00486a55;
        uVar1 = 0;
        if (*(int *)((int)this + 0x58) != 0) {
          do {
      ...
      if ((local_1c == 0) && (*(int *)((int)this + 0x34) != 0)) {
        ...
        if ((local_8 < 0) ||
           (local_8 = MeshData_OptimizeVertexOrder(this,(int)local_14,(int)local_18), local_8 < 0))
        goto LAB_00486a55;
      }
        ...
        *(undefined4 *)((int)this + 0x38) = 0;
        local_8 = MeshBuffer_Allocate(this,*(uint *)((int)this + 0x58),uVar1);
        if (((local_8 < 0) ||
        ...
        if ((local_34 != (void *)0x0) && (*(int *)((int)this + 0x30) != 0)) {
          do {
            *(undefined2 *)(*(int *)((int)this + 0x38) + uVar1 * 2) =
                 *(undefined2 *)
                  ((int)local_14 +
                  (uint)*(ushort *)((int)local_34 + *(int *)(local_28 + uVar1 * 4) * 2) * 4);
            uVar1 = uVar1 + 1;
          } while (uVar1 < *(uint *)((int)this + 0x30));
        }
        uVar1 = 0;
