 ...
 *
 * Description:
 * Constructor for RaceResultsMenu. Stores parent at +4, param_2 at +8, App at +0xC. Increments active count at parent+0x8B4. Sets max frames=500 (+0x14), width=800 (+0x1C). Vtable→0x4D6CFC. Sets scale=1.0f at +0x20. 1 call from ArenaBoard_Update.
 *
 * Struct offsets:
 ...
 *
 * Cross-references:
 *   1 call from ArenaBoard_Update (0x422240)
 *
