 ...
 * Address: 0x0041e640
 * Signature: void __fastcall BoardLevel5_Tower_dtor(undefined4 *param_1)
 *
 * Patterns: SEH frame, scene, board, level. Calls: BoardLevel5_Tower_dtor, Vec3List_Free, Scene_dtor. Offsets: 4, Lines: 48
 *
 * Decompiled from Hamsterball.exe (Athena Engine, PE32 i386)
 */

void __fastcall BoardLevel5_Tower_dtor(undefined4 *param_1)

{
  ...
  *param_1 = &PTR_BoardLevel5_Tower_dtor_004d0a08;
  local_4 = 4;
