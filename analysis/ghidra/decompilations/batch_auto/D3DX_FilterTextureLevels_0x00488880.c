...
uint D3DX_FilterTextureLevels(int *param_1,int *param_2,uint param_3,uint param_4)

{
  ...
  local_1c = piVar1;
  uVar2 = 5;
  if (param_4 != 0xffffffff) goto LAB_00488922;
  if (local_14 == 3) {
...
LAB_00488971:
    bVar5 = param_4 != 0;
    param_4 = uVar2;
    if (bVar5) goto LAB_00488922;
  }
  else {
    if (local_14 == 4) {
      (**(code **)(*piVar1 + 0x38))(piVar1,0,local_68);
      if ((local_54 & local_54 - 1) != 0) goto LAB_0048891b;
      local_30 = local_50 & local_50 - 1;
    }
    else {
      if (local_14 != 5) goto LAB_00488971;
      (**(code **)(*piVar1 + 0x38))(piVar1,0,local_48);
      local_30 = local_30 & local_30 - 1;
      local_4c = local_2c;
    }
    if ((local_30 == 0) && (param_4 = uVar2, (local_4c & local_4c - 1) == 0)) goto LAB_00488922;
  }
LAB_0048891b:
  param_4 = 0x80004;
LAB_00488922:
...
LAB_004889eb:
        ...
        uVar4 = param_3;
        if ((int)uVar2 < 0) goto LAB_00488b1e;
LAB_00488ae3:
        uVar4 = uVar4 + 1;
        if (uVar4 < local_24) {
          if (local_14 == 3) {
...
LAB_00488a33:
          ...
          if (-1 < (int)uVar2) {
            if (local_14 == 3) {
LAB_00488a56:
              uVar2 = D3DX_LoadTextureResource
                                (local_8,param_2,(uint *)0x0,param_1,param_2,(uint *)0x0,param_4,0);
            }
            else if (local_14 == 4) {
              uVar2 = D3DX_LoadTextureMemory
                                (local_10,param_2,(uint *)0x0,local_c,param_2,(uint *)0x0,param_4,0)
              ;
            }
            else if (local_14 == 5) goto LAB_00488a56;
            if (-1 < (int)uVar2) {
              if (local_20 == 0) goto LAB_00488ac3;
              if (param_1 != (int *)0x0) {
