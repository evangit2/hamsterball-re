 ...
 * Address: 0x004217b0
 * Signature: ArenaBoard_ctor(...)
 *
 * Patterns: SEH frame, scene, board. Calls: Board, ArenaBoard_ctor, Board_ctor, AthenaList_Init, CONCAT31, ToggleTimer_Init. Offsets: 16, Lines: 37
 *
 * Decompiled from Hamsterball.exe (Athena Engine, PE32 i386)
 */

/* ArenaBoard_ctor - inherits from Board (Gadget+Scene). Size ~0x47D4. Vtable 0x4D1358. Adds:
   AthenaList@0x4394, RumbleTimer@0x47C8, time_limit@0x47AC=6000, name@0x868="RumbleBoard",
   field_47B0-47C5 */

void * __thiscall ArenaBoard_ctor(void *this,int param_1)

{
  ...
  local_4 = 0;
  *(undefined ***)this = &PTR_ArenaBoard_dtor_004d1358;
  AthenaList_Init((void *)((int)this + 0x4394),0);
  local_4 = CONCAT31(local_4._1_3_,1);
  ToggleTimer_Init((undefined4 *)((int)this + 0x47c8));
