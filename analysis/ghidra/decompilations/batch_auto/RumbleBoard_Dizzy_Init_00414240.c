...

{
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    pvVar1 = MeshWorld_ctor(pvVar1,*(undefined4 *)(param_1[0x21e] + 0x174),"levels\\arena-dizzy");
  }
  local_4 = 0xffffffff;
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    pvVar1 = MeshWorld_ctor(pvVar1,*(undefined4 *)(param_1[0x21e] + 0x174),"Levels\\Level3-Swirl");
  }
  local_4 = 0xffffffff;
  param_1[0x11f8] = (int)pvVar1;
