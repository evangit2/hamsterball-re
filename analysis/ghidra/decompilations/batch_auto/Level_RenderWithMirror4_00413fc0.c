/*
 * Function: Level_RenderWithMirror4
 * Address: 0x00413fc0
 * Signature: Level_RenderWithMirror4(...)
 *
 * Patterns: vtable dispatch, SEH frame, rendering, level. Calls: Level_RenderWithMirror4, Level_RenderDynamicObjects, Graphics_SetProjection, RenderContext_Init, Matrix4_Identity. Offsets: 8, Lines: 76
 *
...
void __thiscall Level_RenderWithMirror4(void *this,void *param_1)

{
  ...
  *(float *)((int)param_1 + 0x794) = fVar2;
  ...
  iVar4 = (int)this + 0x47e0;
  pfVar3 = (float *)((int)this + 0x5840);
  param_1 = (void *)0x4;
  do {
