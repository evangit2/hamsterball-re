 ...
 * Address: 0x00408d70
 * Signature: Ball_SplitIntoThree(...)
 *
 * Patterns: frees memory, allocates, vtable dispatch, SEH frame, audio, ball, scene. Calls: Ball_SplitIntoThree, _free, Sound_PlayChannel, Scene_ForEachBall_SetVelocity, operator_new, Ball_Split_ctor, Ball_SetTrajectory, AthenaList_Append. Offsets: 28, Lines: 107
 *
