...
void Matrix_BuildRotationZYX(float *param_1)

{
  ...
  D3D_ThunkIndirect();
  fVar4 = _DAT_004cf310;
  fVar1 = local_14 * _DAT_004d5c84;
  fVar3 = local_10 * _DAT_004d5c84;
  fVar2 = local_c * _DAT_004d5c84;
  *param_1 = local_14 * fVar1 + _DAT_004cf310;
