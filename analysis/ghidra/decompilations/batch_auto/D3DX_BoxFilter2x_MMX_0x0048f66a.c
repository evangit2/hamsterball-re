...
undefined4 __cdecl
D3DX_BoxFilter2x_MMX
          (uint *param_1,undefined8 *param_2,uint param_3,uint param_4,int param_5,int param_6)

{
  ...
  uVar12 = D3DX_BoxFilter2x_Scalar(param_1,(uint)param_2,param_3,param_4,param_5,param_6);
  return uVar12;
}
