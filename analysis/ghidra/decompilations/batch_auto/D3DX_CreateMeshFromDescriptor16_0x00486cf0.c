...
undefined4 D3DX_CreateMeshFromDescriptor16(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  if (this == (void *)0x0) {
    ...
    this_00 = D3DTexture_InitLocked
                        (this,*(int **)((int)pvVar2 + 0x24),*(uint *)((int)pvVar2 + 4),uVar6);
  }
  ...
  *(int **)(unaff_EBP + -0x10) = this_00;
  if (this_00 == (int *)0x0) {
    *(undefined4 *)(unaff_EBP + 8) = 0x8007000e;
    ...
    iVar5 = MeshBuffer_Allocate(this_00,*(uint *)((int)pvVar2 + 0x58),uVar4);
    *(int *)(unaff_EBP + 8) = iVar5;
    if (-1 < iVar5) {
      ...
      iVar5 = Mesh_CopyFrom16(this_00,pvVar2);
      *(int *)(unaff_EBP + 8) = iVar5;
      if (-1 < iVar5) {
        if ((*(byte *)(this_00 + 3) & 0x20) == 0) {
        ...
        *(int *)(unaff_EBP + 8) = iVar5;
        if (-1 < iVar5) {
          iVar5 = D3DXMesh_OptimizeInternal
