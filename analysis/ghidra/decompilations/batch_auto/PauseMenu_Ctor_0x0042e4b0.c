...
void * __thiscall PauseMenu_Ctor(void *this,int param_1)

{
  ...
  iVar2 = 0;
  local_4 = 0;
  *(undefined ***)this = &PTR_OptionsMenu_DeletingDtor2_004d4120;
  *(char **)((int)this + 0x868) = "Pause Menu";
  ...
  UIList_AddItem(this,"ABORT RACE","BACK",in_stack_ffffffd4,in_stack_ffffffd8,in_stack_ffffffdc,
                 in_stack_ffffffe0,uVar1,iVar2);
  ExceptionList = local_c;
  return this;
}
