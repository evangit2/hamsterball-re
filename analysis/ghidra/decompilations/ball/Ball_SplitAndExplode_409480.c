...
void __fastcall Ball_SplitAndExplode(int param_1)
    ...
    *(undefined1 *)(param_1 + 0x2e8) = 1;
    ...
    do {
      ...
      if (pvVar13 == (void *)0x0) {
        ...
        this = Ball_Split_ctor(pvVar13,*(int *)(param_1 + 0x14));
      }
      uStack_4 = 0xffffffff;
      *(undefined1 *)(this + 0xc9) = 1;
      ...
      Ball_SetTrajectory(this,&PTR_Vec3_dtor_004cf300,*(float *)(param_1 + 0x2ac),
                         *(float *)(param_1 + 0x2b0),*(float *)(param_1 + 0x2b4),
                         *(float *)(param_1 + 0x2b8));
      this[6] = -1;
      ...
      iVar15 = iStack_50 + 1;
      this[0x1d5] = iVar15;
      AthenaList_Append((void *)(*(int *)(param_1 + 0x14) + 0x3204),(int)this);
    ...
    do {
      ...
      auVar16 = Wave_Sin(&PTR_PTR_004f7188,(float)iStack_50);
      fVar2 = (float)(float10)auVar16;
      auVar16 = Wave_Cos(&PTR_PTR_004f7188,(float)iStack_50);
      ...
      if ((float *)((int)pvVar14 + 8) != afStack_18) {
        *(float *)((int)pvVar14 + 8) = (fVar11 + fVar4) - fVar7;
        *(float *)((int)pvVar14 + 0xc) = (fVar12 + fVar5) - fVar8;
        *(float *)((int)pvVar14 + 0x10) = (fVar10 + fVar6) - fVar2;
      }
      pfVar1 = (float *)((int)pvVar14 + 0x14);
      fStack_20 = fVar12 - fVar8;
      fStack_1c = fVar10 - fVar2;
      if (pfVar1 != &fStack_24) {
        *pfVar1 = fVar11 - fVar7;
        *(float *)((int)pvVar14 + 0x18) = fStack_20;
        *(float *)((int)pvVar14 + 0x1c) = fStack_1c;
      }
      iVar15 = RNG_Rand(&PTR_OBJ_VTABLE,0x14,'\0');
      fVar2 = _DAT_004cf310 / (float)(iVar15 + 0x14);
      *pfVar1 = fVar2 * *pfVar1;
      *(float *)((int)pvVar14 + 0x18) = fVar2 * *(float *)((int)pvVar14 + 0x18);
      *(float *)((int)pvVar14 + 0x1c) = fVar2 * *(float *)((int)pvVar14 + 0x1c);
      AthenaList_Append((void *)(*(int *)(param_1 + 0x14) + 0x3b00),(int)pvVar14);
