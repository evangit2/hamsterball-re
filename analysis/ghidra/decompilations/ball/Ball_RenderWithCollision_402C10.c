// Function: Ball_RenderWithCollision
// Address: 0x402C10
// Decompiled: 2026-06-21
// Source: GhidraMCP (create_function + decompile)


void __fastcall Ball_RenderWithCollision(int param_1)

{
  ...
  if (*(char *)(param_1 + 0x324) == '\0') {
    ...
    sVar5 = Ball_TestPlaneIntersection
    ...
    if ((char)sVar5 != '\0') {
      ...
      if (*(int *)(param_1 + 0x2fc) != 0x3f800000) {
        SceneObj_SetScale(*(void **)(*(int *)(param_1 + 0x10) + 0x174),*(int *)(param_1 + 0x2fc));
      }
      ...
      Scene_Render3DObjects
                (*(void **)(*(int *)(param_1 + 0x14) + 0x8ac),iVar3,uVar2,uVar1,(int)uVar6,uVar7,
                 uVar8,cVar9);
      if (*(int *)(param_1 + 0x2fc) != 0x3f800000) {
      ...
      Scene_ZoomOut(*(void **)(*(int *)(param_1 + 0x10) + 0x174));
      this = *(void **)(*(int *)(param_1 + 0x10) + 0x174);
    }
