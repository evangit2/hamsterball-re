 ...
 * [ENABLE]
 * // ============================================================
 * //  SpawnSpinBridge - At Player XZ, Y-10
 * // ============================================================
 * 
 * alloc(SpawnCode, 4096)
 * alloc(SpawnSpinBridge, 4)
 * alloc(saved_board, 4)
 * alloc(playerX, 4)
 * alloc(playerY, 4)
 * alloc(playerZ, 4)
 ...
 * alloc(last_board, 4)
 * 
 * registersymbol(SpawnSpinBridge)
 * 
 * SpawnSpinBridge:
 *   dd 0
 * 
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnSpinBridge], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnSpinBridge], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
 ...
 * dealloc(last_board)
 * unregistersymbol(SpawnSpinBridge)
 * 
 * ================================================================
 */
