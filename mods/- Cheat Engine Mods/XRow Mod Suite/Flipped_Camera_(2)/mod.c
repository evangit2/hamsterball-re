...
static BYTE enable_bytes_0[] = { 0x21, 0xDB, 0x03, 0x00 };
static BYTE disable_bytes_0[] = { 0x41, 0xDB, 0x03, 0x00 };
static BYTE enable_bytes_1[] = { 0x2C, 0xDB, 0x03, 0x00 };
static BYTE disable_bytes_1[] = { 0x0C, 0xDB, 0x03, 0x00 };
static BYTE enable_bytes_2[] = { 0xC4, 0x29 };
static BYTE disable_bytes_2[] = { 0xBC, 0x29 };

static PatchEntry patches[] = {
    { 0x0041A27B, 4, enable_bytes_0, disable_bytes_0, 1 },
    { 0x0041A290, 4, enable_bytes_1, disable_bytes_1, 1 },
    { 0x0041A270, 2, enable_bytes_2, disable_bytes_2, 1 },
};
