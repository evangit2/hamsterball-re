 ...
 * 
 * check_recover:
 *   mov dword [tar_timer], 0
 *   mov byte [esi+0x768], 1
 *   jmp save_pos
 * 
 * apply_tar:
 *   cmp dword [tar_timer], 0
 *   jg dec_timer
 * 
 * do_tar:
 *   mov dword [tar_timer], 60
 * 
 *   mov eax, [esi+0x14]
 *   test eax, eax
 *   jz set_flags
