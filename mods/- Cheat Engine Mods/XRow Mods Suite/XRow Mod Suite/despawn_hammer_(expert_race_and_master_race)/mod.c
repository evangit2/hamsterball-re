...
static BYTE disable_bytes_0[] = { 0x48, 0x41 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x45, 0x3A, 0x43, 0x41, 0x4C };

static PatchEntry patches[] = {
    { 0x004CFABA, 2, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CFAC8, 5, enable_bytes_1, disable_bytes_1, 1 },
};
