...
/* NOTE: the old bumper trampoline (ApplyBumperBounce / BumperCollisionLogic /
 * Hook_DispatchCollisionEvents) was removed — slot 29 now runs
 * UniversalDispatchCollision directly (see lf_06_collision.c). */
