/*
 * "vacuum brings you in the sky (up race)"
...
static BYTE enable_bytes_0[] = { 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_0[] = { 0x56, 0x41, 0x43, 0x2D };

static PatchEntry patches[] = {
    { 0x004CFE1C, 4, enable_bytes_0, disable_bytes_0, 1 },
};
