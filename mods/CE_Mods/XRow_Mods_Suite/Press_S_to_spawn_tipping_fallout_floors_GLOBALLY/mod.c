 ...
 * [ENABLE]
 * // ============================================================
 * //  SpawnTipFall - Pillar Constructor + Fallout Mesh
 * // ============================================================
 * 
 * alloc(SpawnCode, 4096)
 * alloc(SpawnTipFall, 4)
 * alloc(saved_board, 4)
 * alloc(playerX, 4)
 * alloc(playerY, 4)
 * alloc(playerZ, 4)
 ...
 * alloc(temp_mesh, 4)
 * alloc(fallout_array, 36)
 * alloc(last_board, 4)
 * 
 * registersymbol(SpawnTipFall)
 * 
 * SpawnTipFall:
 *   dd 0
 * 
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnTipFall], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnTipFall], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
