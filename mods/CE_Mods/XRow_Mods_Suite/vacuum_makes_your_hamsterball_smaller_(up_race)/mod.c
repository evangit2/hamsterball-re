...
static BYTE enable_bytes_0[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_0[] = { 0x56, 0x41, 0x43, 0x50, 0x4F, 0x50, 0x4F, 0x55, 0x54 };

static PatchEntry patches[] = {
    { 0x004CFE7A, 9, enable_bytes_0, disable_bytes_0, 1 },
};
