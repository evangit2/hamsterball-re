...
static BYTE disable_bytes_0[] = { 0x75, 0x75 };
static BYTE enable_bytes_1[] = { 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x75, 0x19 };

static PatchEntry patches[] = {
    { 0x0040D968, 2, enable_bytes_0, disable_bytes_0, 1 },
    { 0x0040DDBB, 2, enable_bytes_1, disable_bytes_1, 1 },
};
