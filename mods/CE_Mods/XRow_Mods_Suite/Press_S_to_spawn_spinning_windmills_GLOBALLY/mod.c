 ...
 * [ENABLE]
 * // ============================================================
 * //  SpawnWindmill - Spinny Constructor + Windmill Mesh
 * // ============================================================
 * 
 ...
 * 
 * prox_loop:
 *   cmp ebx, [windmill_array]
 *   jae prox_done
 *   mov eax, [windmill_array+4+ebx*4]
 *   test eax, eax
 *   jz prox_next
 *   mov ecx, [eax]
 *   test ecx, ecx
 ...
 *   cmp eax, 16
 *   jae done_spawn
 *   mov [windmill_array+4+eax*4], edi
