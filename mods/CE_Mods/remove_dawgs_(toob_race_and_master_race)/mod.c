...
static BYTE disable_bytes_0[] = { 0x42, 0x4C, 0x4F, 0x43, 0x4B, 0x44, 0x41 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x42, 0x4C, 0x4F, 0x43, 0x4B, 0x44, 0x41 };
static BYTE enable_bytes_2[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_2[] = { 0x42, 0x4C, 0x4F, 0x43, 0x4B, 0x44, 0x41 };

static PatchEntry patches[] = {
    { 0x004CFCC0, 7, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CFCD8, 7, enable_bytes_1, disable_bytes_1, 1 },
    { 0x004CFCF0, 7, enable_bytes_2, disable_bytes_2, 1 },
};
