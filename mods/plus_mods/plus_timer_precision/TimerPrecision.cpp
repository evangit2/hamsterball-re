...
const PatchSite TimerPrecision::s_patches[] = {
    ...
    {0x44CF86, 0x44CFB7, 0xC1, "TT results: time remaining"},
    {0x44D18A, 0x44D1B8, 0xC1, "TT results: par time"},
    {0x44E25F, 0x44E290, 0xC1, "results: race time"},
    {0x44E448, 0x44E479, 0xC1, "results: best time"},
    {0x44E63C, 0x44E66D, 0xC1, "results: weasel time"},
    {0x44EB19, 0x44EB4A, 0xC1, "results: bronze time"},
    {0x44ECFF, 0x44ED30, 0xC1, "results: silver time"},
    {0x44EEE5, 0x44EF16, 0xC1, "results: gold time"},
