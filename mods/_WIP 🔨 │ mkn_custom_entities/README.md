...
| 7    | cEnt_DFloor1_ctor     | 0x43E450 | 0x1104  | (this, board, x, y, z, mesh) — Neon DFLOOR1        |
...
| 15   | BadBall_ctor          | 0x40AFE0 | 0xC98   | (this, board) — no mesh, no position                |
| 16   | Bridgeslam            | Custom   | 0x10D0  | Isolated Intermediate bridge state machine         |
| 17   | cEnt_DFloor2_ctor     | 0x43E450 | 0x1104  | (this, board, x, y, z, mesh) — Neon DFLOOR2        |
| 18   | cEnt_DFloor3_ctor     | 0x43E450 | 0x1104  | (this, board, x, y, z, mesh) — Neon DFLOOR3        |
| 19   | cEnt_DFloor4_ctor     | 0x43E450 | 0x1104  | ArenaStands + post-config (obj+0x10DC=2, +0x10E0=0)|
| 20   | cEnt_FlickRing_ctor   | 0x43E450 | 0x1104  | (this, board, x, y, z, mesh) — Neon Arena FLICKRING |
| 21   | cEnt_Trode_ctor       | 0x43E450 | 0x1104  | (this, board, x, y, z, mesh) — Neon TRODE          |
...
| 27   | Spinner_Level_ctor    | 0x4396F0 | 0x10FC  | Expert Race "BRIDGE" (6 params)                    |
