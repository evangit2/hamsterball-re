/*
 * gluebie_spawn — bass.dll proxy
 * Gluebie Spawn + Tar Effect v5 — spawns Gluebie + triggers tar physics
 *
...
static obj_ctor_t pfn_ctor = (obj_ctor_t)0x437960;
...
static void __cdecl on_frame(void) {
    ...
    /* Per-frame: check ball proximity to gluebies for tar effect */
}
