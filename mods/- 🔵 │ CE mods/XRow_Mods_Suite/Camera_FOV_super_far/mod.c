...
static BYTE enable_bytes_0[] = { 0x9A, 0x99, 0xD9, 0x3F, 0x00, 0x00 };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0x00, 0x3F, 0x00, 0x00 };

static PatchEntry patches[] = {
    { 0x004CF3F0, 6, enable_bytes_0, disable_bytes_0, 1 },
};
