 ...
 *   mov [playerZ], eax
 * @@:
 *   cmp dword ptr [spawnTiny], 0
 *   je original
 *   cmp dword ptr [esi+0x18], 0
 *   jne original
 * 
 *   mov dword ptr [spawnTiny], 0
 ...
 * 
 *   // Tiny radius = 17.0
 *   mov dword ptr [ebx+0x284], 0x41880000
 * 
