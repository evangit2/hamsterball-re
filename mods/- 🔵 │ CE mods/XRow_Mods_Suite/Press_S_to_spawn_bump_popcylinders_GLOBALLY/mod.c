 ...
 * 
 * // =====================================================
 * // Global Bumper Spawner v19 — Fixed Speed 0.2
 * // =====================================================
 * 
 * alloc(BumperCode, 4096)
 * alloc(SpawnBumper3, 4)
 * alloc(saved_board, 4)
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnBumper3], 0
 *   je original_code
 *   cmp dword [esi+18], 0
 *   jne original_code
 *   mov dword [SpawnBumper3], 0
 * 
 * do_spawn:
 *   pushad
 *   mov eax, [esi+14]
