...
static BYTE enable_bytes_0[] = { 0x00, 0x00, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0xC3 };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0x00, 0x3F, 0x00, 0x00, 0x00, 0x00, 0xC3 };

static PatchEntry patches[] = {
    { 0x004CF3F0, 9, enable_bytes_0, disable_bytes_0, 1 },
};
