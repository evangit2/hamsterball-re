...
static BYTE disable_bytes_0[] = { 0x54, 0x45, 0x4E, 0x42, 0x4F };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x54, 0x45, 0x4E, 0x42, 0x4F };

static PatchEntry patches[] = {
    { 0x004D016E, 5, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004D0182, 5, enable_bytes_1, disable_bytes_1, 1 },
};
