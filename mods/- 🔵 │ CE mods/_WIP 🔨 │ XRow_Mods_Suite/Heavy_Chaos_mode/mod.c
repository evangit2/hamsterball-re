...
static BYTE enable_bytes_0[] = { 0x9A, 0x99, 0x99, 0x3E, 0x50, 0x2A, 0x40 };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0x80, 0x3F, 0x50, 0x2A };

static PatchEntry patches[] = {
    { 0x004CF310, 7, enable_bytes_0, disable_bytes_0, 1 },
};
