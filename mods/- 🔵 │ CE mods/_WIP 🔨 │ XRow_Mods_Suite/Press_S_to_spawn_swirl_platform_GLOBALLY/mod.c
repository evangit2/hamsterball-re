 ...
 * [ENABLE]
 * // ============================================================
 * //  SpawnSpinSwirl - Spinny Constructor + Swirl Mesh
 * // ============================================================
 * 
 * alloc(SpawnCode, 4096)
 * alloc(SpawnSpinSwirl, 4)
 * alloc(saved_board, 4)
 * alloc(playerX, 4)
 * alloc(playerY, 4)
 * alloc(playerZ, 4)
 ...
 * alloc(temp_mesh, 4)
 * alloc(swirl_array, 68)
 * alloc(last_board, 4)
 * 
 * registersymbol(SpawnSpinSwirl)
 * 
 * SpawnSpinSwirl:
 *   dd 0
 * 
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnSpinSwirl], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnSpinSwirl], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
 ...
 * dealloc(swirl_array)
 * dealloc(last_board)
 * unregistersymbol(SpawnSpinSwirl)
 * 
 * ================================================================
 */
