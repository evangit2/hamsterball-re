...
static BYTE disable_bytes_0[] = { 0x44, 0x52, 0x41, 0x57, 0x42 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x4F, 0x50, 0x45, 0x4E, 0x53 };

static PatchEntry patches[] = {
    { 0x004CF988, 5, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CF9D6, 5, enable_bytes_1, disable_bytes_1, 1 },
};
