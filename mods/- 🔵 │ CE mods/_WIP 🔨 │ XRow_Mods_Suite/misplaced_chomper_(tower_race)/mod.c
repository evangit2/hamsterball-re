...
static BYTE enable_bytes_0[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_0[] = { 0x43, 0x48, 0x4F, 0x4D, 0x50, 0x45, 0x52, 0x00 };

static PatchEntry patches[] = {
    { 0x004CF968, 8, enable_bytes_0, disable_bytes_0, 1 },
};
