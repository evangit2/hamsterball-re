/*
 * global-windmill — bass.dll proxy
 * Spawns Windmill at player position
 *
...
static obj_ctor_t pfn_obj_ctor = (obj_ctor_t)0x462850;
...
static void* load_mesh(void) {
    ...
    if (!mem) return NULL;
    g_mesh = pfn_meshworld_ctor(mem, gfx, "Levels\\Level4-Windmill");
    return g_mesh;
}
