/*
 * global-bridge-drawbridge — bass.dll proxy
 * Dual spawner: Bridge + Drawbridge
 *
...
static obj_ctor_t pfn_obj_ctor = (obj_ctor_t)0x436D70;
...
static void* load_mesh(void) {
    ...
    if (!mem) return NULL;
    g_mesh = pfn_meshworld_ctor(mem, gfx, "Levels\\Level2-Bridge");
    return g_mesh;
}
