#!/bin/bash
# build.sh — Cross-compile KeyboardForce mod with MinGW
set -e
...
i686-w64-mingw32-g++ -shared -o plus_keyboard_force.dll KeyboardForce_MinGW.cpp nocrt.cpp \
...
echo "Build complete: plus_keyboard_force.dll"
