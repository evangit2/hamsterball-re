#!/bin/bash
# build.sh - Cross-compile Water Mod (HB+) with MinGW
# Uses the MinGW-safe variant (WaterMod_MinGW.cpp) with nocrt + manual vtable.
set -e
...
i686-w64-mingw32-g++ -shared -o plus_water_mod.dll WaterMod_MinGW.cpp nocrt.cpp \
...
echo "Build complete: plus_water_mod.dll"