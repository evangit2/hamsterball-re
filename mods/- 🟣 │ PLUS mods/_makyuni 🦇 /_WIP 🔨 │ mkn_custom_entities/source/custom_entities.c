...
static void process_rotaters(DWORD board, FILE* logf) {
    ...
    for (i = 0; i < obj_count; i++) {
        ...
        static const ai_entry_t ai_list[] = {
            ...
            { "Tarbubble",        25, "levels\\_default" },         /* v55l_1: tarbubble.mesh doesn't exist on disk, use _default MESHWORLD for visibility */
...
static DWORD WINAPI entity_thread(LPVOID param) {
    ...
    if (logf) {
        fprintf(logf, "=== Custom Entities Mod v55l_1 Started ===\n");
