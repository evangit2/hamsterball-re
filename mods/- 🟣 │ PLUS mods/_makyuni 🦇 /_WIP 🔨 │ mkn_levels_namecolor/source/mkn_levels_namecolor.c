/*
 * mkn_levels_namecolor.c — BASS.dll proxy mod
 *
 ...
 *
 * Config file: mkn_levels_namecolor.txt (next to bass.dll)
...
static void init_config_path(void) {
    ...
    if (p) strcpy(p + 1, "mkn_levels_namecolor.txt");
    else   strcpy(g_config_path, "mkn_levels_namecolor.txt");
}
