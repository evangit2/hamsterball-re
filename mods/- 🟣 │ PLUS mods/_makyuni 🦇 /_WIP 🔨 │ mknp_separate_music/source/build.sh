#!/bin/bash
# build.sh — Cross-compile mknp_separate_music HB+ mod with MinGW
set -e
...
i686-w64-mingw32-g++ -shared -o mknp_separate_music.dll mknp_separate_music_MinGW.cpp nocrt.cpp \
...
echo "Build complete: mknp_separate_music.dll"
