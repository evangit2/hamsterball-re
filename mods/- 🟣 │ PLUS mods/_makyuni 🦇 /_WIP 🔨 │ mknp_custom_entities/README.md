...
|  Speedcylinder  |    39  |  levels\Speedcylinder                          |  cEnt_SpeedCylinder_ctor - solid + spin/launch (v55n_2); trigger box from Speedcylinder_trigger.MESHWORLD (v55n_58), rendered visible, non-solid (v55n_69); per-cylinder ROT_Y orientation (v55n_70)  |
