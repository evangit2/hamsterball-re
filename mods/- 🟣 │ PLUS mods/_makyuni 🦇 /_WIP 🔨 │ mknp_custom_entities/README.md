...
|  Speedcylinder  |    39  |  levels\Speedcylinder                          |  cEnt_SpeedCylinder_ctor - solid + spin/launch (v55n_2); trigger box from Speedcylinder_trigger.MESHWORLD (v55n_58), rendered visible, non-solid (v55n_69); per-cylinder fixed world orientation read from the cEnt ref point's own rotation (v55n_71)                                |
