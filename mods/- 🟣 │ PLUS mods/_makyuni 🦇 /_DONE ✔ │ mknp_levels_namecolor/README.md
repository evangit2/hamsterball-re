# mknp_levels_namecolor

**Author:** MAKYUNI 🦇  
**Type:** bass.dll proxy mod (MinGW)  
**Config file:** `mknp_levels_namecolor.txt` (auto-generated next to DLL)
...
2. Copy `mknp_levels_namecolor.dll` as `bass.dll` into the game folder
3. Copy `mknp_levels_namecolor.txt` next to `bass.dll`
...
```bash
i686-w64-mingw32-gcc -shared -o bass.dll mknp_levels_namecolor.c \
