#!/bin/bash
# build.sh — Cross-compile Icon & Window Name mod with MinGW
set -e
...
i686-w64-mingw32-g++ -shared -o mkn_plus_icon_and_windowname.dll IconAndWindowName_MinGW.cpp nocrt.cpp \
...
echo "Build complete: mkn_plus_icon_and_windowname.dll"
