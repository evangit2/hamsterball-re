#!/bin/bash
# build.sh — Cross-compile Custom Race Descriptions mod with MinGW
set -e
...
i686-w64-mingw32-g++ -shared -o mkn_plus_custom_race_descriptions.dll CustomRaceDescriptions_MinGW.cpp nocrt.cpp \
...
echo "Build complete: mkn_plus_custom_race_descriptions.dll"
