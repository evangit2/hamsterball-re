...
static BYTE disable_bytes_0[] = { 0x41, 0x43, 0x54, 0x49, 0x56 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x41, 0x43, 0x54, 0x49, 0x56 };
static BYTE enable_bytes_2[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_2[] = { 0x41, 0x4C, 0x45, 0x52, 0x54 };
static BYTE enable_bytes_3[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_3[] = { 0x41, 0x4C, 0x45, 0x52, 0x54 };

static PatchEntry patches[] = {
    { 0x004CFA82, 5, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CFA92, 5, enable_bytes_1, disable_bytes_1, 1 },
    { 0x004CFAA2, 5, enable_bytes_2, disable_bytes_2, 1 },
    { 0x004CFAAE, 5, enable_bytes_3, disable_bytes_3, 1 },
};
