 ...
 * alloc(float_20, 4)
 * 
 * registersymbol(SpawnNeonPlatform)
 * 
 * SpawnNeonPlatform:
 *   dd 0
 * 
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnNeonPlatform], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnNeonPlatform], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
 ...
 * dealloc(temp_mesh)
 * dealloc(float_20)
 * unregistersymbol(SpawnNeonPlatform)
 * 
 * ================================================================
 */
