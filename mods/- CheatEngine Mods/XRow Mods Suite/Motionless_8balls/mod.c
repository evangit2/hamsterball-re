...
static BYTE enable_bytes_0[] = { 0x00, 0x00, 0x00, 0x00 };
static BYTE disable_bytes_0[] = { 0x96, 0x00, 0x00, 0x00 };
static BYTE enable_bytes_1[] = { 0x00, 0x00, 0x00, 0x00 };
static BYTE disable_bytes_1[] = { 0x88, 0x00, 0x00, 0x00 };
static BYTE enable_bytes_2[] = { 0x00 };
static BYTE disable_bytes_2[] = { 0x7E };
static BYTE enable_bytes_3[] = { 0x00 };
static BYTE disable_bytes_3[] = { 0x74 };
static BYTE enable_bytes_4[] = { 0x00 };
static BYTE disable_bytes_4[] = { 0x67 };
static BYTE enable_bytes_5[] = { 0x00 };
static BYTE disable_bytes_5[] = { 0x61 };

static PatchEntry patches[] = {
    { 0x0040859A, 4, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004085A8, 4, enable_bytes_1, disable_bytes_1, 1 },
    { 0x004085B5, 1, enable_bytes_2, disable_bytes_2, 1 },
    { 0x004085BF, 1, enable_bytes_3, disable_bytes_3, 1 },
    { 0x004085CC, 1, enable_bytes_4, disable_bytes_4, 1 },
    { 0x004085D2, 1, enable_bytes_5, disable_bytes_5, 1 },
};
