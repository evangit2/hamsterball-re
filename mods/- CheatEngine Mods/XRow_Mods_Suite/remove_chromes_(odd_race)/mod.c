...
static BYTE disable_bytes_0[] = { 0x4C, 0x41, 0x55, 0x4E, 0x43 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x4C, 0x41, 0x55, 0x4E, 0x43 };
static BYTE enable_bytes_2[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_2[] = { 0x4C, 0x41, 0x55, 0x4E, 0x43 };

static PatchEntry patches[] = {
    { 0x004CFAE8, 5, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CFAF4, 5, enable_bytes_1, disable_bytes_1, 1 },
    { 0x004CFB00, 5, enable_bytes_2, disable_bytes_2, 1 },
};
