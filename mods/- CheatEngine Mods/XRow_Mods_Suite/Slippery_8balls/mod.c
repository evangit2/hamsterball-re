...
static BYTE enable_bytes_0[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_0[] = { 0x0F, 0x85, 0x82, 0x01, 0x00, 0x00 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x0F, 0x85, 0x74, 0x01, 0x00, 0x00 };
static BYTE enable_bytes_2[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_2[] = { 0x0F, 0x85, 0x66, 0x01, 0x00, 0x00 };
static BYTE enable_bytes_3[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_3[] = { 0x0F, 0x8F, 0x57, 0x01, 0x00, 0x00 };
static BYTE enable_bytes_4[] = { 0x90, 0x90 };
static BYTE disable_bytes_4[] = { 0x74, 0x36 };
static BYTE enable_bytes_5[] = { 0x00, 0x00, 0x48, 0x42 };
static BYTE disable_bytes_5[] = { 0x00, 0x00, 0xC0, 0x40 };

static PatchEntry patches[] = {
    { 0x0040265B, 6, enable_bytes_0, disable_bytes_0, 1 },
    { 0x00402669, 6, enable_bytes_1, disable_bytes_1, 1 },
    { 0x00402677, 6, enable_bytes_2, disable_bytes_2, 1 },
    { 0x00402686, 6, enable_bytes_3, disable_bytes_3, 1 },
    { 0x004026B2, 2, enable_bytes_4, disable_bytes_4, 1 },
    { 0x004CF3E8, 4, enable_bytes_5, disable_bytes_5, 1 },
};
