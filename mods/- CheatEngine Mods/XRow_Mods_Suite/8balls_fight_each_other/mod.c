...
static BYTE disable_bytes_0[] = { 0x0F, 0x84, 0x76, 0x04, 0x00, 0x00 };
static BYTE enable_bytes_1[] = { 0x39, 0xFE, 0x90, 0x90, 0x74, 0x61 };
static BYTE disable_bytes_1[] = { 0x83, 0x7F, 0x18, 0xFF, 0x74, 0x61 };

static PatchEntry patches[] = {
    { 0x004083AE, 6, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004085CD, 6, enable_bytes_1, disable_bytes_1, 1 },
};
