/*
 * "Many hamsters come out when ball breaks"
...
static BYTE enable_bytes_0[] = { 0x83, 0xFB, 0x1E };
static BYTE disable_bytes_0[] = { 0x83, 0xFB, 0x03 };

static PatchEntry patches[] = {
    { 0x00809454, 3, enable_bytes_0, disable_bytes_0, 1 },
};
