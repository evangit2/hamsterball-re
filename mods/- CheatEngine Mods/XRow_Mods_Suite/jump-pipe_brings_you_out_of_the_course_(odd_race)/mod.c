...
static BYTE disable_bytes_0[] = { 0x4A, 0x55, 0x4D, 0x50, 0x50 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0xDB, 0x4A, 0x55, 0x4D, 0x50, 0x50 };

static PatchEntry patches[] = {
    { 0x004CFBE8, 5, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CFBCC, 5, enable_bytes_1, disable_bytes_1, 1 },
};
