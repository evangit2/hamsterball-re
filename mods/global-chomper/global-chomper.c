/*
 * global-chomper — bass.dll proxy
 * Spawns Chomper object at player position
 *
...
static obj_ctor_t pfn_obj_ctor = (obj_ctor_t)0x465080;
...
static void* load_mesh(void) {
    ...
    if (!mem) return NULL;
    g_mesh = pfn_meshworld_ctor(mem, gfx, "Meshes\\Chomper");
    return g_mesh;
}
