 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnFlickring], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnFlickring], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
 ...
 * dealloc(temp_mesh)
 * dealloc(float_20)
 * unregistersymbol(SpawnFlickring)
 * 
 * ================================================================
 */
