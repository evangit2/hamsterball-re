...
static BYTE enable_bytes_0[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x59, 0x40, 0xCD };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x3F, 0xCD };

static PatchEntry patches[] = {
    { 0x004CF3C8, 9, enable_bytes_0, disable_bytes_0, 1 },
};
