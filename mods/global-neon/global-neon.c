/*
 * global-neon — bass.dll proxy
 * Spawn Neon objects + lighting
 *
...
static obj_ctor_t pfn_obj_ctor = (obj_ctor_t)0x43E110;
...
static void* load_mesh(void) {
    ...
    if (!mem) return NULL;
    g_mesh = pfn_meshworld_ctor(mem, gfx, "Levels\\LevelDark-NeonPlatform");
    return g_mesh;
}
