...
static BYTE enable_bytes_0[] = { 0x00, 0x50, 0x43, 0x47, 0x01, 0x01 };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0x80, 0x3F, 0x01, 0x01 };

static PatchEntry patches[] = {
    { 0x004FDECC, 6, enable_bytes_0, disable_bytes_0, 1 },
};
