...
static BYTE enable_bytes_0[] = { 0x00, 0x80, 0xBB, 0x44, 0x9A, 0x99 };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0x7F, 0x43, 0x9A };

static PatchEntry patches[] = {
    { 0x004CF304, 6, enable_bytes_0, disable_bytes_0, 1 },
};
