...
static BYTE enable_bytes_0[] = { 0x4B, 0x61, 0x6B, 0x61, 0x79, 0x20, 0x4B, 0x61, 0x6B, 0x61, 0x79, 0x20, 0x42, 0x61, 0x6B, 0x61, 0x00 };
static BYTE disable_bytes_0[] = { 0 }; /* original unknown */
static BYTE enable_bytes_1[] = { 0x4B, 0x61, 0x6B, 0x61, 0x79, 0x20, 0x42, 0x61, 0x6B, 0x61, 0x00 };
static BYTE disable_bytes_1[] = { 0 }; /* original unknown */
static BYTE enable_bytes_2[] = { 0x4B, 0x61, 0x6B, 0x61, 0x79, 0x20, 0x42, 0x61, 0x6B, 0x61, 0x00 };
static BYTE disable_bytes_2[] = { 0 }; /* original unknown */

static PatchEntry patches[] = {
    { 0x004D410C, 17, enable_bytes_0, disable_bytes_0, 0 },
    { 0x004D3F00, 11, enable_bytes_1, disable_bytes_1, 0 },
    { 0x004D4810, 11, enable_bytes_2, disable_bytes_2, 0 },
};
