...
static BYTE disable_bytes_0[] = { 0x88, 0x85, 0x68, 0x07, 0x00, 0x00 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0xC6, 0x86, 0x68, 0x07, 0x00, 0x00, 0x00 };

static PatchEntry patches[] = {
    { 0x0040C761, 6, enable_bytes_0, disable_bytes_0, 1 },
    { 0x0040F226, 7, enable_bytes_1, disable_bytes_1, 1 },
};
