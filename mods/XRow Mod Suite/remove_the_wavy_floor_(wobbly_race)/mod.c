...
static BYTE disable_bytes_0[] = { 0x57, 0x41, 0x56, 0x59, 0x31 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x57, 0x41, 0x56, 0x59 };

static PatchEntry patches[] = {
    { 0x004CFC68, 5, enable_bytes_0, disable_bytes_0, 1 },
    { 0x004CFC82, 4, enable_bytes_1, disable_bytes_1, 1 },
};
