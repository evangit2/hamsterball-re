...
static BYTE enable_bytes_0[] = { 0x00, 0x00, 0x0C, 0x42, 0xCD, 0xCC };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0xA0, 0x41, 0xCD };

static PatchEntry patches[] = {
    { 0x004CF370, 6, enable_bytes_0, disable_bytes_0, 1 },
};
