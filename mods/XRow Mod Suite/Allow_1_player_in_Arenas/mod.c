...
static BYTE enable_bytes_0[] = { 0xEB };
static BYTE disable_bytes_0[] = { 0x75 };
static BYTE enable_bytes_1[] = { 0xEB };
static BYTE disable_bytes_1[] = { 0x75 };
static BYTE enable_bytes_2[] = { 0xEB };
static BYTE disable_bytes_2[] = { 0x75 };

static PatchEntry patches[] = {
    { 0x00431121, 1, enable_bytes_0, disable_bytes_0, 1 },
    { 0x00431129, 1, enable_bytes_1, disable_bytes_1, 1 },
    { 0x00431131, 1, enable_bytes_2, disable_bytes_2, 1 },
};
