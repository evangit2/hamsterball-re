...
static BYTE enable_bytes_0[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_0[] = { 0xC6, 0x85, 0xE9, 0x02, 0x00, 0x00, 0x01 };
static BYTE enable_bytes_1[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0xC6, 0x86, 0xE9, 0x02, 0x00, 0x00, 0x01 };
static BYTE enable_bytes_2[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_2[] = { 0xFF, 0x86, 0xEC, 0x02, 0x00, 0x00 };
static BYTE enable_bytes_3[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_3[] = { 0x88, 0x85, 0x68, 0x07, 0x00, 0x00 };
static BYTE enable_bytes_4[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 };
static BYTE disable_bytes_4[] = { 0xC6, 0x86, 0x68, 0x07, 0x00, 0x00, 0x00 };
static BYTE enable_bytes_5[] = { 0xC3, 0x90, 0x90 };
static BYTE disable_bytes_5[] = { 0x6A, 0xFF, 0x64, 0xA1 };
static BYTE enable_bytes_6[] = { 0xC3, 0x90, 0x90 };
static BYTE disable_bytes_6[] = { 0x6A, 0xFF, 0x64, 0xA1 };
static BYTE enable_bytes_7[] = { 0xC3, 0x90, 0x90 };
static BYTE disable_bytes_7[] = { 0x6A, 0xFF, 0x64, 0xA1 };

static PatchEntry patches[] = {
    { 0x0040C767, 7, enable_bytes_0, disable_bytes_0, 1 },
    { 0x0040F22D, 7, enable_bytes_1, disable_bytes_1, 1 },
    { 0x004075C9, 6, enable_bytes_2, disable_bytes_2, 1 },
    { 0x0040C761, 6, enable_bytes_3, disable_bytes_3, 1 },
    { 0x0040F226, 7, enable_bytes_4, disable_bytes_4, 1 },
    { 0x00408D70, 3, enable_bytes_5, disable_bytes_5, 1 },
    { 0x00409050, 3, enable_bytes_6, disable_bytes_6, 1 },
    { 0x00409480, 3, enable_bytes_7, disable_bytes_7, 1 },
};
