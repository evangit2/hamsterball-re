 ...
 * 
 * // =====================================================
 * // Global Platform Spawner — Six Platforms
 * // =====================================================
 * 
 * alloc(PlatCode, 4096)
 * alloc(SpawnMPlats, 4)
 * alloc(SpawnMPlats2, 4)
 * alloc(SpawnMPlats3, 4)
 * alloc(SpawnMPlats4, 4)
 * alloc(SpawnMPlats5, 4)
 * alloc(SpawnMPlats6, 4)
 * alloc(saved_board, 4)
 * alloc(plat_array, 68)
 * alloc(our_mesh, 4)
 * alloc(temp_mesh, 4)
 ...
 * alloc(last_board, 4)
 * 
 * registersymbol(SpawnMPlats)
 * registersymbol(SpawnMPlats2)
 * registersymbol(SpawnMPlats3)
 * registersymbol(SpawnMPlats4)
 * registersymbol(SpawnMPlats5)
 * registersymbol(SpawnMPlats6)
 * 
 * SpawnMPlats:
 *   dd 0
 * SpawnMPlats2:
 ...
 * 
 * check_b1:
 *   cmp dword [SpawnMPlats], 0
 *   je check_b2
 *   cmp dword [esi+18], 0
 *   jne check_b2
 *   mov dword [SpawnMPlats], 0
 *   mov dword [mesh_select], 004D055C
 *   jmp do_spawn
 * 
 * check_b2:
 *   cmp dword [SpawnMPlats2], 0
 *   je check_b3
 *   cmp dword [esi+18], 0
 *   jne check_b3
 *   mov dword [SpawnMPlats2], 0
 *   mov dword [mesh_select], 004D0CF4
 *   jmp do_spawn
 * 
 * check_b3:
 *   cmp dword [SpawnMPlats3], 0
 *   je check_b4
 *   cmp dword [esi+18], 0
 *   jne check_b4
 *   mov dword [SpawnMPlats3], 0
 *   mov dword [mesh_select], 004CFFE0
 *   jmp do_spawn
 * 
 * check_b4:
 *   cmp dword [SpawnMPlats4], 0
 *   je check_b5
 *   cmp dword [esi+18], 0
 *   jne check_b5
 *   mov dword [SpawnMPlats4], 0
 *   mov dword [mesh_select], 004D341C
 *   jmp do_spawn
 * 
 * check_b5:
 *   cmp dword [SpawnMPlats5], 0
 *   je check_b6
 *   cmp dword [esi+18], 0
 *   jne check_b6
 *   mov dword [SpawnMPlats5], 0
 *   mov dword [mesh_select], 004CFF98
 *   jmp do_spawn
 * 
 * check_b6:
 *   cmp dword [SpawnMPlats6], 0
 *   je original_code
 *   cmp dword [esi+18], 0
 *   jne original_code
 *   mov dword [SpawnMPlats6], 0
 ...
 * dealloc(PlatCode)
 * dealloc(SpawnMPlats)
 * dealloc(SpawnMPlats2)
 * dealloc(SpawnMPlats3)
 * dealloc(SpawnMPlats4)
 * dealloc(SpawnMPlats5)
 * dealloc(SpawnMPlats6)
 * dealloc(saved_board)
 * dealloc(plat_array)
 * dealloc(our_mesh)
 * dealloc(temp_mesh)
 ...
 * dealloc(angle)
 * dealloc(last_board)
 * unregistersymbol(SpawnMPlats)
 * unregistersymbol(SpawnMPlats2)
 * unregistersymbol(SpawnMPlats3)
 * unregistersymbol(SpawnMPlats4)
 * unregistersymbol(SpawnMPlats5)
 * unregistersymbol(SpawnMPlats6)
 * 
 * ================================================================
 */
