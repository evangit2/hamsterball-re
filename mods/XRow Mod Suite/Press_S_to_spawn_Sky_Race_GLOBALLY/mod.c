 ...
 * [ENABLE]
 * // ============================================================
 * //  Global Sky Race Spawner
 * //  Spawns Level9 geometry at Player 1 position
 * // ============================================================
 * 
 * alloc(SpawnCode, 4096)
 * alloc(SpawnSkyRace, 4)
 * alloc(saved_board, 4)
 * alloc(playerX, 4)
 * alloc(playerY, 4)
 * alloc(playerZ, 4)
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnSkyRace], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnSkyRace], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
