...
static BYTE enable_bytes_0[] = { 0x90, 0x90 };
static BYTE disable_bytes_0[] = { 0x75, 0x07 };
static BYTE enable_bytes_1[] = { 0x90, 0x90 };
static BYTE disable_bytes_1[] = { 0x75, 0x2A };

static PatchEntry patches[] = {
    { 0x0040F04A, 2, enable_bytes_0, disable_bytes_0, 1 },
    { 0x0040F005, 2, enable_bytes_1, disable_bytes_1, 1 },
};
