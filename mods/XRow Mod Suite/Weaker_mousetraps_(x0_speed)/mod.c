...
static BYTE enable_bytes_0[] = { 0x00, 0x00, 0xA0, 0x90, 0xDF, 0xCC, 0x4C };
static BYTE disable_bytes_0[] = { 0x00, 0x00, 0xA0, 0x41, 0xCD, 0xCC, 0x4C };

static PatchEntry patches[] = {
    { 0x004CF370, 7, enable_bytes_0, disable_bytes_0, 1 },
};
