 ...
 * [ENABLE]
 * // ============================================================
 * //  Global Bridge Spawner - Using Pillar Constructor Pattern
 * //  Pillar constructor + Bridge mesh = auto-animating bridge
 * // ============================================================
 * 
 * alloc(SpawnCode, 4096)
 * alloc(SpawnBridge1, 4)
 * alloc(saved_board, 4)
 * alloc(playerX, 4)
 * alloc(playerY, 4)
 * alloc(playerZ, 4)
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnBridge1], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnBridge1], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
 ...
 *   mov [temp_mesh], eax
 * 
 *   // Allocate with Pillar size 0x1100
 *   push 0x1100
 *   call 004BA57B
 *   add esp, 4
 *   test eax, eax
 ...
 *   mov edi, eax
 * 
 *   // Call Pillar constructor with Bridge mesh
 *   mov edx, [temp_mesh]
 *   push edx
 *   mov edx, [playerZ]
 *   push edx
