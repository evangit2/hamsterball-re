 ...
 * [ENABLE]
 * // ============================================================
 * //  SpawnSwirlPillar - Pillar Constructor + Swirl Mesh
 * // ============================================================
 * 
 * alloc(SpawnCode, 4096)
 * alloc(SpawnSwirlPillar, 4)
 * alloc(saved_board, 4)
 * alloc(playerX, 4)
 * alloc(playerY, 4)
 * alloc(playerZ, 4)
 ...
 * alloc(float_50, 4)
 * alloc(temp_mesh, 4)
 * alloc(swirl_array, 36)
 * alloc(last_board, 4)
 * 
 * registersymbol(SpawnSwirlPillar)
 * 
 * SpawnSwirlPillar:
 *   dd 0
 * 
 ...
 * 
 * check_spawn:
 *   cmp dword [SpawnSwirlPillar], 0
 *   je original_code
 *   cmp dword [esi+0x18], 0
 *   jne original_code
 *   mov dword [SpawnSwirlPillar], 0
 * 
 *   pushad
 *   mov eax, [esi+0x14]
 *   mov [saved_board], eax
 ...
 *   cmp eax, 8
 *   jae done_spawn
 *   mov [swirl_array+4+eax*4], edi
 *   inc dword [swirl_array]
 * 
 * done_spawn:
 *   popad
 ...
 * dealloc(swirl_array)
 * dealloc(last_board)
 * unregistersymbol(SpawnSwirlPillar)
 * 
 * ================================================================
 */
