 ...
 *   mov [playerZ], eax
 * @@:
 *   cmp dword ptr [spawnMini], 0
 *   je original
 *   cmp dword ptr [esi+0x18], 0
 *   jne original
 * 
 *   mov dword ptr [spawnMini], 0
