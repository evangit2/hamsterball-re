 ...
 * 
 *   // Zero physics body velocity too
 *   push eax
 *   mov eax, [esi+0x1A4]
 *   test eax, eax
 *   jz skip_phys
 *   mov dword ptr [eax+0xCA4], 0   // phys vel_x
 *   mov dword ptr [eax+0xCA8], 0   // phys vel_y
 *   mov dword ptr [eax+0xCAC], 0   // phys vel_z
 * skip_phys:
 *   pop eax
 * 
