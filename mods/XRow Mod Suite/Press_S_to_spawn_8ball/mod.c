 ...
 *   mov dword ptr [ebx+0xC6C], 0x49742400  // CHASE = 1000000
 *   mov dword ptr [ebx+0xC70], 0x49742400  // HOME = 1000000
 *   mov dword ptr [ebx+0xC7C], 0           // SPINDISTANCE = 0
 * 
 * no_new:
